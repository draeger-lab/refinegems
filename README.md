...
| Available on | [![PyPI version](https://img.shields.io/pypi/v/refinegems?logo=pypi&label=PyPI%20package&color=neongreen)](https://pypi.org/project/refineGEMs/) ![PyPI - Format](https://img.shields.io/pypi/format/refinegems?) |
| &nbsp; | [![Docker Image Version](https://img.shields.io/docker/v/biodatalab/refinegems?logo=docker&label=Docker%20Image)](https://hub.docker.com/r/biodatalab/refinegems) ![Docker Pulls](https://img.shields.io/docker/pulls/biodatalab/refinegems) |
| &nbsp; | [![Conda Version](https://img.shields.io/conda/vn/bioconda/refinegems?logo=anaconda)](https://anaconda.org/channels/bioconda/packages/refinegems/overview) ![Conda Downloads](https://img.shields.io/conda/dn/bioconda/refinegems) |
...
- [refineGEMs](#refinegems)
    ...
    - [Installation](#installation)
        ...
        - [docker Via Docker](#docker-via-docker)
            - [(a) Image from Docker Hub](#a-image-from-docker-hub)
            - [(b) Local build](#b-local-build)
