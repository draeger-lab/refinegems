...
INSERT INTO media_compositions(BiGG, substance, medium_id) VALUES
	...
	('hg2', 'Hg2+', (SELECT id from media WHERE medium='LB')),
	...
	('k', 'K+', (SELECT id from media WHERE medium='LB')),
	...
	('mg2', 'Mg', (SELECT id from media WHERE medium='LB')),
	('mn2', 'Mn2+', (SELECT id from media WHERE medium='LB')),
	('mobd', 'Molybdate', (SELECT id from media WHERE medium='LB')),
	('na1', 'Na+', (SELECT id from media WHERE medium='LB')),
	('nac', 'Isonicotinic acid', (SELECT id from media WHERE medium='LB')),
	...
	('pnto__R', 'PAN', (SELECT id from media WHERE medium='LB')),
	('pro__L', 'L-Proline', (SELECT id from media WHERE medium='LB')),
	('pydx', 'Pyridoxal', (SELECT id from media WHERE medium='LB')),
	...
	('zn2', 'Zn2+', (SELECT id from media WHERE medium='LB')),
	('adn', 'Adenosine', (SELECT id from media WHERE medium='LB[-O2]')),
	('ala__L', 'L-Alanine', (SELECT id from media WHERE medium='LB[-O2]')),
	('amp', 'AMP', (SELECT id from media WHERE medium='LB[-O2]')),
	('arg__L', 'L-Arginine', (SELECT id from media WHERE medium='LB[-O2]')),
	('aso3', 'Arsenite', (SELECT id from media WHERE medium='LB[-O2]')),
	('asp__L', 'L-Aspartate', (SELECT id from media WHERE medium='LB[-O2]')),
	('ca2', 'Ca2+', (SELECT id from media WHERE medium='LB[-O2]')),
	('cbl1', 'Vitamin B12', (SELECT id from media WHERE medium='LB[-O2]')),
	('cd2', 'Cadmium', (SELECT id from media WHERE medium='LB[-O2]')),
	('cl', 'Cl-', (SELECT id from media WHERE medium='LB[-O2]')),
	('cmp', 'CMP', (SELECT id from media WHERE medium='LB[-O2]')),
	('cobalt2', 'Co2+', (SELECT id from media WHERE medium='LB[-O2]')),
	('cro4', 'Chromate', (SELECT id from media WHERE medium='LB[-O2]')),
	('cu2', 'Cu2+', (SELECT id from media WHERE medium='LB[-O2]')),
	('cys__L', 'L-Cysteine', (SELECT id from media WHERE medium='LB[-O2]')),
	('dad_2', 'Deoxyadenosine', (SELECT id from media WHERE medium='LB[-O2]')),
	('dcyt', 'Deoxycytidine', (SELECT id from media WHERE medium='LB[-O2]')),
	('fe2', 'Fe2+', (SELECT id from media WHERE medium='LB[-O2]')),
	('fe3', 'Fe3+', (SELECT id from media WHERE medium='LB[-O2]')),
	('fol', 'Folate', (SELECT id from media WHERE medium='LB[-O2]')),
	('glc__D', 'D-Glucose', (SELECT id from media WHERE medium='LB[-O2]')),
	('glu__L', 'L-Glutamate', (SELECT id from media WHERE medium='LB[-O2]')),
	('gly', 'Glycine', (SELECT id from media WHERE medium='LB[-O2]')),
	('gmp', 'GMP', (SELECT id from media WHERE medium='LB[-O2]')),
	('gsn', 'Guanosine', (SELECT id from media WHERE medium='LB[-O2]')),
	('h2o', 'H2O', (SELECT id from media WHERE medium='LB[-O2]')),
	('h2s', 'Hydrogen sulfide', (SELECT id from media WHERE medium='LB[-O2]')),
	('h', 'H+', (SELECT id from media WHERE medium='LB[-O2]')),
	('hg2', 'Hg2+', (SELECT id from media WHERE medium='LB[-O2]')),
	('his__L', 'L-Histidine', (SELECT id from media WHERE medium='LB[-O2]')),
	('hxan', 'Hypoxanthine', (SELECT id from media WHERE medium='LB[-O2]')),
	('ile__L', 'L-Isoleucine', (SELECT id from media WHERE medium='LB[-O2]')),
	('ins', 'Inosine', (SELECT id from media WHERE medium='LB[-O2]')),
	('k', 'K+', (SELECT id from media WHERE medium='LB[-O2]')),
	('leu__L', 'L-Leucine', (SELECT id from media WHERE medium='LB[-O2]')),
	('lipoate', 'Lipoate', (SELECT id from media WHERE medium='LB[-O2]')),
	('lys__L', 'L-Lysine', (SELECT id from media WHERE medium='LB[-O2]')),
	('met__L', 'L-Methionine', (SELECT id from media WHERE medium='LB[-O2]')),
	('mg2', 'Mg', (SELECT id from media WHERE medium='LB[-O2]')),
	('mn2', 'Mn2+', (SELECT id from media WHERE medium='LB[-O2]')),
	('mobd', 'Molybdate', (SELECT id from media WHERE medium='LB[-O2]')),
	('na1', 'Na+', (SELECT id from media WHERE medium='LB[-O2]')),
	('nac', 'Isonicotinic acid', (SELECT id from media WHERE medium='LB[-O2]')),
	('nh4', 'Ammonium', (SELECT id from media WHERE medium='LB[-O2]')),
	('ni2', 'Ni2+', (SELECT id from media WHERE medium='LB[-O2]')),
	('phe__L', 'L-Phenylalanine', (SELECT id from media WHERE medium='LB[-O2]')),
	('pheme', 'Protoheme', (SELECT id from media WHERE medium='LB[-O2]')),
	('pi', 'Phosphate', (SELECT id from media WHERE medium='LB[-O2]')),
	('pnto__R', 'PAN', (SELECT id from media WHERE medium='LB[-O2]')),
	('pro__L', 'L-Proline', (SELECT id from media WHERE medium='LB[-O2]')),
	('pydx', 'Pyridoxal', (SELECT id from media WHERE medium='LB[-O2]')),
	('ribflv', 'Riboflavin', (SELECT id from media WHERE medium='LB[-O2]')),
	('ser__L', 'L-Serine', (SELECT id from media WHERE medium='LB[-O2]')),
	('so4', 'Sulfate', (SELECT id from media WHERE medium='LB[-O2]')),
	('thm', 'Thiamin', (SELECT id from media WHERE medium='LB[-O2]')),
	('thr__L', 'L-Threonine', (SELECT id from media WHERE medium='LB[-O2]')),
	('thymd', 'Thymidine', (SELECT id from media WHERE medium='LB[-O2]')),
	('trp__L', 'L-Tryptophan', (SELECT id from media WHERE medium='LB[-O2]')),
	('tyr__L', 'L-Tyrosine', (SELECT id from media WHERE medium='LB[-O2]')),
	('ump', 'UMP', (SELECT id from media WHERE medium='LB[-O2]')),
	('ura', 'Uracil', (SELECT id from media WHERE medium='LB[-O2]')),
	('uri', 'Uridine', (SELECT id from media WHERE medium='LB[-O2]')),
	('val__L', 'L-Valine', (SELECT id from media WHERE medium='LB[-O2]')),
	('zn2', 'Zn2+', (SELECT id from media WHERE medium='LB[-O2]')),
	('ca2', 'Ca2+', (SELECT id from media WHERE medium='M9')),
	('cl', 'Cl-', (SELECT id from media WHERE medium='M9')),
	('cobalt2', 'Co2+', (SELECT id from media WHERE medium='M9')),
	('cu2', 'Cu2+', (SELECT id from media WHERE medium='M9')),
	('fe2', 'Fe2+', (SELECT id from media WHERE medium='M9')),
	('fe3', 'Fe3+', (SELECT id from media WHERE medium='M9')),
	...
	('mn2', 'Mn2+', (SELECT id from media WHERE medium='M9')),
	('mobd', 'Molybdate', (SELECT id from media WHERE medium='M9')),
	('na1', 'Na+', (SELECT id from media WHERE medium='M9')),
	('nh4', 'Ammonium', (SELECT id from media WHERE medium='M9')),
	('ni2', 'Ni2+', (SELECT id from media WHERE medium='M9')),
	...
	('zn2', 'Zn2+', (SELECT id from media WHERE medium='M9')),
	('ca2', 'Ca2+', (SELECT id from media WHERE medium='M9[-O2]')),
	('cl', 'Cl-', (SELECT id from media WHERE medium='M9[-O2]')),
	('cobalt2', 'Co2+', (SELECT id from media WHERE medium='M9[-O2]')),
	('cu2', 'Cu2+', (SELECT id from media WHERE medium='M9[-O2]')),
	('fe2', 'Fe2+', (SELECT id from media WHERE medium='M9[-O2]')),
	('fe3', 'Fe3+', (SELECT id from media WHERE medium='M9[-O2]')),
	('glc__D', 'D-Glucose', (SELECT id from media WHERE medium='M9[-O2]')),
	('h2o', 'H2O', (SELECT id from media WHERE medium='M9[-O2]')),
	('h', 'H+', (SELECT id from media WHERE medium='M9[-O2]')),
	('k', 'K+', (SELECT id from media WHERE medium='M9[-O2]')),
	('mg2', 'Mg', (SELECT id from media WHERE medium='M9[-O2]')),
	('mn2', 'Mn2+', (SELECT id from media WHERE medium='M9[-O2]')),
	('mobd', 'Molybdate', (SELECT id from media WHERE medium='M9[-O2]')),
	('na1', 'Na+', (SELECT id from media WHERE medium='M9[-O2]')),
	('nh4', 'Ammonium', (SELECT id from media WHERE medium='M9[-O2]')),
	('ni2', 'Ni2+', (SELECT id from media WHERE medium='M9[-O2]')),
	('pi', 'Phosphate', (SELECT id from media WHERE medium='M9[-O2]')),
	('so4', 'Sulfate', (SELECT id from media WHERE medium='M9[-O2]')),
	('zn2', 'Zn2+', (SELECT id from media WHERE medium='M9[-O2]')),
	('ca2', 'Ca2+', (SELECT id from media WHERE medium='M9[glyc]')),
	('cl', 'Cl-', (SELECT id from media WHERE medium='M9[glyc]')),
	('cobalt2', 'Co2+', (SELECT id from media WHERE medium='M9[glyc]')),
	('cu2', 'Cu2+', (SELECT id from media WHERE medium='M9[glyc]')),
	('fe2', 'Fe2+', (SELECT id from media WHERE medium='M9[glyc]')),
	('fe3', 'Fe3+', (SELECT id from media WHERE medium='M9[glyc]')),
	('glyc', 'Glycerol', (SELECT id from media WHERE medium='M9[glyc]')),
	('h2o', 'H2O', (SELECT id from media WHERE medium='M9[glyc]')),
	('h', 'H+', (SELECT id from media WHERE medium='M9[glyc]')),
	('k', 'K+', (SELECT id from media WHERE medium='M9[glyc]')),
	('mg2', 'Mg', (SELECT id from media WHERE medium='M9[glyc]')),
	('mn2', 'Mn2+', (SELECT id from media WHERE medium='M9[glyc]')),
	('mobd', 'Molybdate', (SELECT id from media WHERE medium='M9[glyc]')),
	('na1', 'Na+', (SELECT id from media WHERE medium='M9[glyc]')),
	('nh4', 'Ammonium', (SELECT id from media WHERE medium='M9[glyc]')),
	('ni2', 'Ni2+', (SELECT id from media WHERE medium='M9[glyc]')),
	('o2', 'O2', (SELECT id from media WHERE medium='M9[glyc]')),
	('pi', 'Phosphate', (SELECT id from media WHERE medium='M9[glyc]')),
	('so4', 'Sulfate', (SELECT id from media WHERE medium='M9[glyc]')),
	('zn2', 'Zn2+', (SELECT id from media WHERE medium='M9[glyc]')),
	('ala__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('arg__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('cys__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('glu__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('gly', NULL, (SELECT id from media WHERE medium='SNM3')),
	('his__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('leu__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('lys__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('orn', NULL, (SELECT id from media WHERE medium='SNM3')),
	('phe__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('pro__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('ser__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('thr__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('trp__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('val__L', NULL, (SELECT id from media WHERE medium='SNM3')),
	('cit', NULL, (SELECT id from media WHERE medium='SNM3')),
	('fum', NULL, (SELECT id from media WHERE medium='SNM3')),
	('male', NULL, (SELECT id from media WHERE medium='SNM3')),
	('pyr', NULL, (SELECT id from media WHERE medium='SNM3')),
	('succ', NULL, (SELECT id from media WHERE medium='SNM3')),
	('glc__D', NULL, (SELECT id from media WHERE medium='SNM3')),
	('urea', NULL, (SELECT id from media WHERE medium='SNM3')),
	('na1', NULL, (SELECT id from media WHERE medium='SNM3')),
	('cl', NULL, (SELECT id from media WHERE medium='SNM3')),
	('k', NULL, (SELECT id from media WHERE medium='SNM3')),
	('pi', NULL, (SELECT id from media WHERE medium='SNM3')),
	('mg2', NULL, (SELECT id from media WHERE medium='SNM3')),
	('so4', NULL, (SELECT id from media WHERE medium='SNM3')),
	(NULL, '2,2-Bipyridine', (SELECT id from media WHERE medium='SNM3')),
	('ca2', NULL, (SELECT id from media WHERE medium='SNM3')),
	('zn2', NULL, (SELECT id from media WHERE medium='SNM3')),
	('mn2', NULL, (SELECT id from media WHERE medium='SNM3')),
	(NULL, 'H3BO3', (SELECT id from media WHERE medium='SNM3')),
	('cobalt2', NULL, (SELECT id from media WHERE medium='SNM3')),
	('cu2', NULL, (SELECT id from media WHERE medium='SNM3')),
	('ni2', NULL, (SELECT id from media WHERE medium='SNM3')),
	('mobd', NULL, (SELECT id from media WHERE medium='SNM3')),
	('adocbl', NULL, (SELECT id from media WHERE medium='SNM3')),
	('4abz', NULL, (SELECT id from media WHERE medium='SNM3')),
	('btn', NULL, (SELECT id from media WHERE medium='SNM3')),
	('nac', NULL, (SELECT id from media WHERE medium='SNM3')),
	('pnto__R', NULL, (SELECT id from media WHERE medium='SNM3')),
	('pydam', NULL, (SELECT id from media WHERE medium='SNM3')),
	('thm', NULL, (SELECT id from media WHERE medium='SNM3')),
	('ribflv', NULL, (SELECT id from media WHERE medium='SNM3')),
	('o2', NULL, (SELECT id from media WHERE medium='SNM3')),
	('fe2', NULL, (SELECT id from media WHERE medium='SNM3')),
	('h2o', NULL, (SELECT id from media WHERE medium='SNM3')),
	('co2', NULL, (SELECT id from media WHERE medium='SNM3')),
	('na1', NULL, (SELECT id from media WHERE medium='SMM')),
	('cl', NULL, (SELECT id from media WHERE medium='SMM')),
	('k', NULL, (SELECT id from media WHERE medium='SMM')),
	('mg2', NULL, (SELECT id from media WHERE medium='SMM')),
	('so4', NULL, (SELECT id from media WHERE medium='SMM')),
	('h2o', NULL, (SELECT id from media WHERE medium='SMM')),
	('nh4', NULL, (SELECT id from media WHERE medium='SMM')),
	('ca2', NULL, (SELECT id from media WHERE medium='SMM')),
	('pi', NULL, (SELECT id from media WHERE medium='SMM')),
	('fe2', NULL, (SELECT id from media WHERE medium='SMM')),
	('mn2', NULL, (SELECT id from media WHERE medium='SMM')),
	('glc__D', NULL, (SELECT id from media WHERE medium='SMM')),
	('arg__L', NULL, (SELECT id from media WHERE medium='SMM')),
	('cys__L', NULL, (SELECT id from media WHERE medium='SMM')),
	('pro__L', NULL, (SELECT id from media WHERE medium='SMM')),
	('nac', NULL, (SELECT id from media WHERE medium='SMM')),
	('thm', NULL, (SELECT id from media WHERE medium='SMM')),
	('pnto__R', NULL, (SELECT id from media WHERE medium='SMM')),
	('h', NULL, (SELECT id from media WHERE medium='SMM')),
	('ca2', NULL, (SELECT id from media WHERE medium='RPMI')),
	('no3', NULL, (SELECT id from media WHERE medium='RPMI')),
	('mg2', NULL, (SELECT id from media WHERE medium='RPMI')),
	('so4', NULL, (SELECT id from media WHERE medium='RPMI')),
	('cl', NULL, (SELECT id from media WHERE medium='RPMI')),
	('k', NULL, (SELECT id from media WHERE medium='RPMI')),
	('na1', NULL, (SELECT id from media WHERE medium='RPMI')),
	('pi', NULL, (SELECT id from media WHERE medium='RPMI')),
	('gly', NULL, (SELECT id from media WHERE medium='RPMI')),
	('arg__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('asn__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('asp__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('cys__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('glu__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('gln__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('his__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('ile__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('leu__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('met__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('phe__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('pro__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('ser__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('thr__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('trp__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('tyr__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('val__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('lys__L', NULL, (SELECT id from media WHERE medium='RPMI')),
	('btn', NULL, (SELECT id from media WHERE medium='RPMI')),
	('chol', NULL, (SELECT id from media WHERE medium='RPMI')),
	('ncam', NULL, (SELECT id from media WHERE medium='RPMI')),
	('4abz', NULL, (SELECT id from media WHERE medium='RPMI')),
	('ribflv', NULL, (SELECT id from media WHERE medium='RPMI')),
	('thm', NULL, (SELECT id from media WHERE medium='RPMI')),
	('inost', NULL, (SELECT id from media WHERE medium='RPMI')),
	('pnto__R', NULL, (SELECT id from media WHERE medium='RPMI')),
	('fol', NULL, (SELECT id from media WHERE medium='RPMI')),
	('clb1', NULL, (SELECT id from media WHERE medium='RPMI')),
	('pydxn', NULL, (SELECT id from media WHERE medium='RPMI')),
	('cbl1', NULL, (SELECT id from media WHERE medium='RPMI')),
	('nac', NULL, (SELECT id from media WHERE medium='RPMI')),
	('glc__D', NULL, (SELECT id from media WHERE medium='RPMI')),
	('gthrd', NULL, (SELECT id from media WHERE medium='RPMI')),
	('h2o', NULL, (SELECT id from media WHERE medium='RPMI')),
	('o2', NULL, (SELECT id from media WHERE medium='RPMI')),
	('co2', NULL, (SELECT id from media WHERE medium='RPMI')),
	('ca2', 'Ca', (SELECT id from media WHERE medium='CGXII')),
	('cl', 'Cl', (SELECT id from media WHERE medium='CGXII')),
	('h2o', 'H2O', (SELECT id from media WHERE medium='CGXII')),
	('btn', 'biotin', (SELECT id from media WHERE medium='CGXII')),
	('fe2', 'Fe2+', (SELECT id from media WHERE medium='CGXII')),
	('fe3', 'FE3+', (SELECT id from media WHERE medium='CGXII')),
	('so4', 'SO4', (SELECT id from media WHERE medium='CGXII')),
	('mn2', 'Mn', (SELECT id from media WHERE medium='CGXII')),
	('zn2', 'Zn', (SELECT id from media WHERE medium='CGXII')),
	('cu2', 'Cu', (SELECT id from media WHERE medium='CGXII')),
	('ni2', 'Ni', (SELECT id from media WHERE medium='CGXII')),
	('h', 'H', (SELECT id from media WHERE medium='CGXII')),
	('na1', 'Na', (SELECT id from media WHERE medium='CGXII')),
	('34dhbz', 'Protocatechuate', (SELECT id from media WHERE medium='CGXII')),
	('nh4', 'NH4', (SELECT id from media WHERE medium='CGXII')),
	('urea', 'urea', (SELECT id from media WHERE medium='CGXII')),
	('k', 'K', (SELECT id from media WHERE medium='CGXII')),
	('pi', 'PO4', (SELECT id from media WHERE medium='CGXII')),
	('mg2', 'Mg', (SELECT id from media WHERE medium='CGXII')),
	('mops', 'MOPS', (SELECT id from media WHERE medium='CGXII')),
	('o2', 'O2', (SELECT id from media WHERE medium='CGXII')),
	('glc__D', 'D-Glucose', (SELECT id from media WHERE medium='CGXII')),
	...
	('nh4', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('so4', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('k', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('pi', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('urea', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('ca2', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('cl', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('mg2', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('fe2', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('mn2', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('ni2', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('cu2', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('zn2', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('btn', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('glc__D', NULL, (SELECT id from media WHERE medium='CGXlab')),
	('h2o', NULL, (SELECT id from media WHERE medium='CGXlab')),
