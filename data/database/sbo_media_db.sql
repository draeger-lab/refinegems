...
-- SMM
	('na1', 'Na+', (SELECT id from media WHERE medium='SMM')),
	('cl', 'Chloride', (SELECT id from media WHERE medium='SMM')),
	('k', 'Potassium', (SELECT id from media WHERE medium='SMM')),
	('mg2', 'Magnesium', (SELECT id from media WHERE medium='SMM')),
	('so4', 'Sulfate', (SELECT id from media WHERE medium='SMM')),
	('h2o', 'water', (SELECT id from media WHERE medium='SMM')),
	('nh4', 'Ammonium', (SELECT id from media WHERE medium='SMM')),
	('ca2', 'Calcium', (SELECT id from media WHERE medium='SMM')),
	('pi', 'Phosphate', (SELECT id from media WHERE medium='SMM')),
	('fe2', 'Iron', (SELECT id from media WHERE medium='SMM')),
	('mn2', 'Manganese', (SELECT id from media WHERE medium='SMM')),
	('glc__D', 'D-Glucose', (SELECT id from media WHERE medium='SMM')),
	('arg__L', 'Arginine', (SELECT id from media WHERE medium='SMM')),
	('cys__L', 'L-Cysteine', (SELECT id from media WHERE medium='SMM')),
	('pro__L', 'Proline', (SELECT id from media WHERE medium='SMM')),
	('nac', 'Nicotinic acid', (SELECT id from media WHERE medium='SMM')),
	('thm', 'Thiamin', (SELECT id from media WHERE medium='SMM')),
	('pnto__R', 'Pantothenic acid; (R)-Pantothenate', (SELECT id from media WHERE medium='SMM')),
	('h', 'H+; Hydrogen', (SELECT id from media WHERE medium='SMM')),
-- RPMI
...
-- Blood
	...
	('q10', 'Ubiquinone-10 [Ubiquinone-1]', (SELECT id from media WHERE medium='Blood')),
	...
	('gbside_hs', 'Tetrahexosylceramide (d18:1/12:0)', (SELECT id from media WHERE medium='Blood')),
...
--GMM
	('glc__D', 'D-Glucose', (SELECT id from media WHERE medium='GMM')),
	('glc__bD', 'D-Glucose', (SELECT id from media WHERE medium='GMM')),
	('fru', 'Fructose', (SELECT id from media WHERE medium='GMM')),
	('cellb', 'Cellobiose', (SELECT id from media WHERE medium='GMM')),
	('malt', 'Maltose', (SELECT id from media WHERE medium='GMM')),
	(NULL, 'Resazurin (KEGG: C11178)', (SELECT id from media WHERE medium='GMM')),
	('hemeD', 'Heme D [Hematin]', (SELECT id from media WHERE medium='GMM')),
	('his__L', 'L-Histidine', (SELECT id from media WHERE medium='GMM')),
	('cys__L', 'L-Cysteine', (SELECT id from media WHERE medium='GMM')),
	('fe2', 'Fe2+ [FeSO4 . 7H2O]', (SELECT id from media WHERE medium='GMM')),
	('so4', 'Sulfate [FeSO4 . 7H2O]', (SELECT id from media WHERE medium='GMM')),
	('h2o', 'H2O [FeSO4 . 7H2O]', (SELECT id from media WHERE medium='GMM')),
	('zn2', 'Zinc [ZnSO4 * 7H2O]', (SELECT id from media WHERE medium='GMM')),
	('cobalt2', 'Co2+ [Co(NO3)2 . 6H2O]', (SELECT id from media WHERE medium='GMM')),
	('no3', 'Nitrate [Co(NO3)2 . 6H2O]', (SELECT id from media WHERE medium='GMM')),
	('k', 'Potassium [AlK(SO4)2 (anhydrous)]', (SELECT id from media WHERE medium='GMM')),
	('na1', 'Sodium [NaCl]', (SELECT id from media WHERE medium='GMM')),
	('cl', 'Chloride [NaCl]', (SELECT id from media WHERE medium='GMM')),
	('slnt', 'Selenite [Na2SeO3 (anhydrous)]', (SELECT id from media WHERE medium='GMM')),
	('tungs', 'Tungstate [Na2WO4 . 2H2O]', (SELECT id from media WHERE medium='GMM')),
	('ni2', 'Nickel [NiCl2 . 6H2O]', (SELECT id from media WHERE medium='GMM')),
	('ca2', 'Calcium [CaCl2 (anhydrous)]', (SELECT id from media WHERE medium='GMM')),
	('cu2', 'Copper [CuSO4 (anhydrous)]', (SELECT id from media WHERE medium='GMM')),
	(NULL, 'H3BO3', (SELECT id from media WHERE medium='GMM')),
	('mn2', 'Manganese [MnSO4 * H2O]', (SELECT id from media WHERE medium='GMM')),
	('mg2', 'Magnesium [MgSO4 * 7H2O]', (SELECT id from media WHERE medium='GMM')),
	('hco3', 'Bicarbonate [NaHCO3]', (SELECT id from media WHERE medium='GMM')),
	('mobd', 'Molybdate [Na2MoO4 . 2H2O]', (SELECT id from media WHERE medium='GMM')),
	('btn', 'Biotin', (SELECT id from media WHERE medium='GMM')),
	('thm', 'Thiamin [Thiamine HCl]', (SELECT id from media WHERE medium='GMM')),
	('ribflv', 'Riboflavin', (SELECT id from media WHERE medium='GMM')),
	('nac', 'Nicotinate [Niacin]', (SELECT id from media WHERE medium='GMM')),
	('nicnt', 'Nicotinate [Niacin]', (SELECT id from media WHERE medium='GMM')),
	('pydxn', 'Pyridoxine [Pyridoxine HCl]', (SELECT id from media WHERE medium='GMM')),
	('pnto__R', '(R)-Pantothenate [Calcium Pantothenate]', (SELECT id from media WHERE medium='GMM')),
	('fol', 'Folate [Folic acid]', (SELECT id from media WHERE medium='GMM')),
	('4abz', '4-Aminobenzoate [p-Aminobenzoic acid]', (SELECT id from media WHERE medium='GMM')),
	('lipoate', 'Lipoate [Lipoic acid]', (SELECT id from media WHERE medium='GMM')),
	('lipopb', 'Lipoate (protein bound) [Lipoic acid]', (SELECT id from media WHERE medium='GMM')),
	('b12', 'Vitamin B12', (SELECT id from media WHERE medium='GMM')),
	('cbl1', 'Cob(I)alamin [Vitamin B12]', (SELECT id from media WHERE medium='GMM')),
	('cbl2', 'Cob(II)alamin [Vitamin B12]', (SELECT id from media WHERE medium='GMM')),
	('mndn', 'Menadione [Vitamin K (menadione)]', (SELECT id from media WHERE medium='GMM')),
	('ac', 'Acetate [Acetic acid]', (SELECT id from media WHERE medium='GMM')),
	('M03134', 'Valeric acid [Isovaleric acid]', (SELECT id from media WHERE medium='GMM')),
	('ival', 'Isovalerate [Isovaleric acid]', (SELECT id from media WHERE medium='GMM')),
	('ppa', 'Propionate [Propionic acid]', (SELECT id from media WHERE medium='GMM')),
