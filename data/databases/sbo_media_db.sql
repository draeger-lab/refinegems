...
--	PRIMARY KEY(substance_id, bigg_id),
...
--
INSERT INTO media(name, description) VALUES
	('LB', 'Lysogeny broth'),
	('LB[-O2]', 'Lysogeny broth (anaerobic)'),
	('M9', 'M9 minimal medium'),
	('M9[-O2]', 'M9 minimal medium (anaerobic)'),
	('M9[glyc]', 'M9 minimal medium (glycerol)'),
	('SNM3', 'Synthetic Nasal Medium Version 3'),
	('SMM', 'Synthetic Minimal Medium'),
	('RPMI', 'RPMI 1640'),
...
--
INSERT INTO media_compositions(bigg_id, name, medium_id) VALUES
	('adn', 'Adenosine', (SELECT medium_id from media WHERE name='LB')),
	('ala__L',	'L-Alanine', (SELECT medium_id from media WHERE name='LB')),
	('amp', 'AMP', (SELECT medium_id from media WHERE name='LB')),
	('arg__L', 'L-Arginine', (SELECT medium_id from media WHERE name='LB')),
	('aso3', 'Arsenite', (SELECT medium_id from media WHERE name='LB')),
	('asp__L', 'L-Aspartate', (SELECT medium_id from media WHERE name='LB')),
	('ca2', 'Ca2+', (SELECT medium_id from media WHERE name='LB')),
	('cbl1', 'Vitamin B12', (SELECT medium_id from media WHERE name='LB')),
	('cd2', 'Cadmium', (SELECT medium_id from media WHERE name='LB')),
	('cl', 'Cl-', (SELECT medium_id from media WHERE name='LB')),
	('cmp', 'CMP', (SELECT medium_id from media WHERE name='LB')),
	('cobalt2', 'Co2+', (SELECT medium_id from media WHERE name='LB')),
	('cro4', 'Chromate', (SELECT medium_id from media WHERE name='LB')),
	('cu2', 'Cu2+', (SELECT medium_id from media WHERE name='LB')),
	('cys__L', 'L-Cysteine', (SELECT medium_id from media WHERE name='LB')),
	('dad_2', 'Deoxyadenosine', (SELECT medium_id from media WHERE name='LB')),
	('dcyt', 'Deoxycytidine', (SELECT medium_id from media WHERE name='LB')),
	('fe2', 'Fe2+', (SELECT medium_id from media WHERE name='LB')),
	('fe3', 'Fe3+', (SELECT medium_id from media WHERE name='LB')),
	('fol', 'Folate', (SELECT medium_id from media WHERE name='LB')),
	('glc__D', 'D-Glucose', (SELECT medium_id from media WHERE name='LB')),
	('glu__L', 'L-Glutamate', (SELECT medium_id from media WHERE name='LB')),
	('gly', 'Glycine', (SELECT medium_id from media WHERE name='LB')),
	('gmp', 'GMP', (SELECT medium_id from media WHERE name='LB')),
	('gsn', 'Guanosine', (SELECT medium_id from media WHERE name='LB')),
	('h2o', 'H2O', (SELECT medium_id from media WHERE name='LB')),
	('h2s', 'Hydrogen sulfide', (SELECT medium_id from media WHERE name='LB')),
	('h', 'H+', (SELECT medium_id from media WHERE name='LB')),
	('hg2', 'Hg2+', (SELECT medium_id from media WHERE name='LB')),
	('his__L', 'L-Histidine', (SELECT medium_id from media WHERE name='LB')),
	('hxan', 'Hypoxanthine', (SELECT medium_id from media WHERE name='LB')),
	('ile__L', 'L-Isoleucine', (SELECT medium_id from media WHERE name='LB')),
	('ins', 'Inosine', (SELECT medium_id from media WHERE name='LB')),
	('k', 'K+', (SELECT medium_id from media WHERE name='LB')),
	('leu__L', 'L-Leucine', (SELECT medium_id from media WHERE name='LB')),
	('lipoate', 'Lipoate', (SELECT medium_id from media WHERE name='LB')),
	('lys__L', 'L-Lysine', (SELECT medium_id from media WHERE name='LB')),
	('met__L', 'L-Methionine', (SELECT medium_id from media WHERE name='LB')),
	('mg2', 'Mg', (SELECT medium_id from media WHERE name='LB')),
	('mn2', 'Mn2+', (SELECT medium_id from media WHERE name='LB')),
	('mobd', 'Molybdate', (SELECT medium_id from media WHERE name='LB')),
	('na1', 'Na+', (SELECT medium_id from media WHERE name='LB')),
	('nac', 'Isonicotinic acid', (SELECT medium_id from media WHERE name='LB')),
	('nh4', 'Ammonium', (SELECT medium_id from media WHERE name='LB')),
	('ni2', 'Ni2+', (SELECT medium_id from media WHERE name='LB')),
	('o2', 'O2', (SELECT medium_id from media WHERE name='LB')),
	('phe__L', 'L-Phenylalanine', (SELECT medium_id from media WHERE name='LB')),
	('pheme', 'Protoheme', (SELECT medium_id from media WHERE name='LB')),
	('pi', 'Phosphate', (SELECT medium_id from media WHERE name='LB')),
	('pnto__R', 'PAN', (SELECT medium_id from media WHERE name='LB')),
	('pro__L', 'L-Proline', (SELECT medium_id from media WHERE name='LB')),
	('pydx', 'Pyridoxal', (SELECT medium_id from media WHERE name='LB')),
	('ribflv', 'Riboflavin', (SELECT medium_id from media WHERE name='LB')),
	('ser__L', 'L-Serine', (SELECT medium_id from media WHERE name='LB')),
	('so4', 'Sulfate', (SELECT medium_id from media WHERE name='LB')),
	('thm', 'Thiamin', (SELECT medium_id from media WHERE name='LB')),
	('thr__L', 'L-Threonine', (SELECT medium_id from media WHERE name='LB')),
	('thymd', 'Thymidine', (SELECT medium_id from media WHERE name='LB')),
	('trp__L', 'L-Tryptophan', (SELECT medium_id from media WHERE name='LB')),
	('tyr__L', 'L-Tyrosine', (SELECT medium_id from media WHERE name='LB')),
	('ump', 'UMP', (SELECT medium_id from media WHERE name='LB')),
	('ura', 'Uracil', (SELECT medium_id from media WHERE name='LB')),
	('uri', 'Uridine', (SELECT medium_id from media WHERE name='LB')),
	('val__L', 'L-Valine', (SELECT medium_id from media WHERE name='LB')),
	('zn2', 'Zn2+', (SELECT medium_id from media WHERE name='LB')),
	('adn', 'Adenosine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ala__L', 'L-Alanine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('amp', 'AMP', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('arg__L', 'L-Arginine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('aso3', 'Arsenite', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('asp__L', 'L-Aspartate', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ca2', 'Ca2+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('cbl1', 'Vitamin B12', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('cd2', 'Cadmium', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('cl', 'Cl-', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('cmp', 'CMP', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('cobalt2', 'Co2+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('cro4', 'Chromate', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('cu2', 'Cu2+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('cys__L', 'L-Cysteine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('dad_2', 'Deoxyadenosine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('dcyt', 'Deoxycytidine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('fe2', 'Fe2+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('fe3', 'Fe3+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('fol', 'Folate', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('glc__D', 'D-Glucose', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('glu__L', 'L-Glutamate', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('gly', 'Glycine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('gmp', 'GMP', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('gsn', 'Guanosine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('h2o', 'H2O', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('h2s', 'Hydrogen sulfide', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('h', 'H+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('hg2', 'Hg2+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('his__L', 'L-Histidine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('hxan', 'Hypoxanthine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ile__L', 'L-Isoleucine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ins', 'Inosine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('k', 'K+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('leu__L', 'L-Leucine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('lipoate', 'Lipoate', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('lys__L', 'L-Lysine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('met__L', 'L-Methionine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('mg2', 'Mg', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('mn2', 'Mn2+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('mobd', 'Molybdate', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('na1', 'Na+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('nac', 'Isonicotinic acid', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('nh4', 'Ammonium', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ni2', 'Ni2+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('phe__L', 'L-Phenylalanine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('pheme', 'Protoheme', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('pi', 'Phosphate', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('pnto__R', 'PAN', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('pro__L', 'L-Proline', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('pydx', 'Pyridoxal', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ribflv', 'Riboflavin', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ser__L', 'L-Serine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('so4', 'Sulfate', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('thm', 'Thiamin', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('thr__L', 'L-Threonine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('thymd', 'Thymidine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('trp__L', 'L-Tryptophan', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('tyr__L', 'L-Tyrosine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ump', 'UMP', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ura', 'Uracil', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('uri', 'Uridine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('val__L', 'L-Valine', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('zn2', 'Zn2+', (SELECT medium_id from media WHERE name='LB[-O2]')),
	('ca2', 'Ca2+', (SELECT medium_id from media WHERE name='M9')),
	('cl', 'Cl-', (SELECT medium_id from media WHERE name='M9')),
	('cobalt2', 'Co2+', (SELECT medium_id from media WHERE name='M9')),
	('cu2', 'Cu2+', (SELECT medium_id from media WHERE name='M9')),
	('fe2', 'Fe2+', (SELECT medium_id from media WHERE name='M9')),
	('fe3', 'Fe3+', (SELECT medium_id from media WHERE name='M9')),
	('glc__D', 'D-Glucose', (SELECT medium_id from media WHERE name='M9')),
	('h2o', 'H2O', (SELECT medium_id from media WHERE name='M9')),
	('h', 'H+', (SELECT medium_id from media WHERE name='M9')),
	('k', 'K+', (SELECT medium_id from media WHERE name='M9')),
	('mg2', 'Mg', (SELECT medium_id from media WHERE name='M9')),
	('mn2', 'Mn2+', (SELECT medium_id from media WHERE name='M9')),
	('mobd', 'Molybdate', (SELECT medium_id from media WHERE name='M9')),
	('na1', 'Na+', (SELECT medium_id from media WHERE name='M9')),
	('nh4', 'Ammonium', (SELECT medium_id from media WHERE name='M9')),
	('ni2', 'Ni2+', (SELECT medium_id from media WHERE name='M9')),
	('o2', 'O2', (SELECT medium_id from media WHERE name='M9')),
	('pi', 'Phosphate', (SELECT medium_id from media WHERE name='M9')),
	('so4', 'Sulfate', (SELECT medium_id from media WHERE name='M9')),
	('zn2', 'Zn2+', (SELECT medium_id from media WHERE name='M9')),
	('ca2', 'Ca2+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('cl', 'Cl-', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('cobalt2', 'Co2+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('cu2', 'Cu2+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('fe2', 'Fe2+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('fe3', 'Fe3+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('glc__D', 'D-Glucose', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('h2o', 'H2O', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('h', 'H+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('k', 'K+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('mg2', 'Mg', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('mn2', 'Mn2+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('mobd', 'Molybdate', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('na1', 'Na+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('nh4', 'Ammonium', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('ni2', 'Ni2+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('pi', 'Phosphate', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('so4', 'Sulfate', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('zn2', 'Zn2+', (SELECT medium_id from media WHERE name='M9[-O2]')),
	('ca2', 'Ca2+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('cl', 'Cl-', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('cobalt2', 'Co2+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('cu2', 'Cu2+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('fe2', 'Fe2+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('fe3', 'Fe3+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('glyc', 'Glycerol', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('h2o', 'H2O', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('h', 'H+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('k', 'K+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('mg2', 'Mg', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('mn2', 'Mn2+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('mobd', 'Molybdate', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('na1', 'Na+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('nh4', 'Ammonium', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('ni2', 'Ni2+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('o2', 'O2', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('pi', 'Phosphate', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('so4', 'Sulfate', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('zn2', 'Zn2+', (SELECT medium_id from media WHERE name='M9[glyc]')),
	('ala__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('arg__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('cys__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('glu__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('gly', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('his__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('leu__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('lys__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('orn', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('phe__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('pro__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('ser__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('thr__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('trp__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('val__L', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('cit', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('fum', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('male', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('pyr', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('succ', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('glc__D', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('urea', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('na1', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('cl', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('k', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('pi', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('mg2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('so4', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	(NULL, '2,2-Bipyridine', (SELECT medium_id from media WHERE name='SNM3')),
	('ca2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('zn2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('mn2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	(NULL, 'H3BO3', (SELECT medium_id from media WHERE name='SNM3')),
	('cobalt2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('cu2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('ni2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('mobd', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('adocbl', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('4abz', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('btn', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('nac', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('pnto__R', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('pydam', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('thm', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('ribflv', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('o2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('fe2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('h2o', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('co2', NULL, (SELECT medium_id from media WHERE name='SNM3')),
	('na1', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('cl', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('k', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('mg2', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('so4', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('h2o', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('nh4', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('ca2', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('pi', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('fe2', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('mn2', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('glc__D', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('arg__L', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('cys__L', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('pro__L', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('nac', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('thm', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('pnto__R', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('h', NULL, (SELECT medium_id from media WHERE name='SMM')),
	('ca2', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('no3', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('mg2', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('so4', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('cl', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('k', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('na1', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('pi', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('gly', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('arg__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('asn__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('asp__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('cys__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('glu__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('gln__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('his__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('ile__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('leu__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('met__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('phe__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('pro__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('ser__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('thr__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('trp__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('tyr__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('val__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('lys__L', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('btn', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('chol', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('ncam', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('4abz', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('ribflv', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('thm', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('inost', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('pnto__R', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('fol', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('clb1', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('pydxn', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('cbl1', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('nac', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('glc__D', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('gthrd', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('h2o', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('o2', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('co2', NULL, (SELECT medium_id from media WHERE name='RPMI')),
	('ca2', 'Ca', (SELECT medium_id from media WHERE name='CGXII')),
	('cl', 'Cl', (SELECT medium_id from media WHERE name='CGXII')),
	('h2o', 'H2O', (SELECT medium_id from media WHERE name='CGXII')),
	('btn', 'biotin', (SELECT medium_id from media WHERE name='CGXII')),
	('fe2', 'Fe2+', (SELECT medium_id from media WHERE name='CGXII')),
	('fe3', 'FE3+', (SELECT medium_id from media WHERE name='CGXII')),
	('so4', 'SO4', (SELECT medium_id from media WHERE name='CGXII')),
	('mn2', 'Mn', (SELECT medium_id from media WHERE name='CGXII')),
	('zn2', 'Zn', (SELECT medium_id from media WHERE name='CGXII')),
	('cu2', 'Cu', (SELECT medium_id from media WHERE name='CGXII')),
	('ni2', 'Ni', (SELECT medium_id from media WHERE name='CGXII')),
	('h', 'H', (SELECT medium_id from media WHERE name='CGXII')),
	('na1', 'Na', (SELECT medium_id from media WHERE name='CGXII')),
	('34dhbz', 'Protocatechuate', (SELECT medium_id from media WHERE name='CGXII')),
	('nh4', 'NH4', (SELECT medium_id from media WHERE name='CGXII')),
	('urea', 'urea', (SELECT medium_id from media WHERE name='CGXII')),
	('k', 'K', (SELECT medium_id from media WHERE name='CGXII')),
	('pi', 'PO4', (SELECT medium_id from media WHERE name='CGXII')),
	('mg2', 'Mg', (SELECT medium_id from media WHERE name='CGXII')),
	('mops', 'MOPS', (SELECT medium_id from media WHERE name='CGXII')),
	('o2', 'O2', (SELECT medium_id from media WHERE name='CGXII')),
	('glc__D', 'D-Glucose', (SELECT medium_id from media WHERE name='CGXII')),
	('lys__L', 'Lysine', (SELECT medium_id from media WHERE name='CasA')),
	('his__L', 'Histidine', (SELECT medium_id from media WHERE name='CasA')),
	('arg__L', 'Arginine', (SELECT medium_id from media WHERE name='CasA')),
	('asp__L', 'Aspartic acid', (SELECT medium_id from media WHERE name='CasA')),
	('thr__L', 'Threonine', (SELECT medium_id from media WHERE name='CasA')),
	('glu__L', 'Glutamic acid', (SELECT medium_id from media WHERE name='CasA')),
	('gly', 'Glycine', (SELECT medium_id from media WHERE name='CasA')),
	('val__L', 'Valine', (SELECT medium_id from media WHERE name='CasA')),
	('met__L', 'Methionine', (SELECT medium_id from media WHERE name='CasA')),
	('ile__L', 'Isoleucine', (SELECT medium_id from media WHERE name='CasA')),
	('leu__L', 'Leucine', (SELECT medium_id from media WHERE name='CasA')),
	('tyr__L', 'Tyrosine', (SELECT medium_id from media WHERE name='CasA')),
	('phe__L', 'Phenylalanine', (SELECT medium_id from media WHERE name='CasA')),
	('nh4', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('so4', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('k', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('pi', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('urea', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('ca2', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('cl', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('mg2', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('fe2', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('mn2', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('ni2', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('cu2', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('zn2', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('btn', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('glc__D', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('h2o', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('o2', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('na1', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('h', NULL, (SELECT medium_id from media WHERE name='CGXlab')),
	('34dhbz', NULL, (SELECT medium_id from media WHERE name='CGXlab'));
