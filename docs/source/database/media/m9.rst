...
:footcite:p:`hawkeyCuratedCollectionKlebsiella2022`. The medium definition used in ``refineGEMs``' database is based on 
the provider reference\ :footcite:p:`M9Minimalsalze5XPowder` and was further supplemented with MgSO\ :sub:`4`\ \* 7H\ :sub:`2`\ O, 
