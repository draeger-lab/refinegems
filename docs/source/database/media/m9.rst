...
The medium definition used in this study is based on the provider reference\ :footcite:p:`M9Minimalsalze5XPowder` and was further supplemented with MgSO\ :sub:`4`\ \* 7H\ :sub:`2`\ O, CaCl\ :sub:`2`\ \* 2H\ :sub:`2`\ O and Glucose\ :footcite:p:`Baeuerle2023_M9_repo,Baeuerle2023_M9`.
