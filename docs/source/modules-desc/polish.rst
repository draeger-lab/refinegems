...
CarveMe version 1.5.1 leads to some problems in the model. The function
:py:func:`~refinegems.curation.curate.polish_model` enables, for example, the addition of BiGG IDs
