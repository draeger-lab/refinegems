...
INSERT INTO substance(name, formula) VALUES
	...
	('1 Methylnicotinamide [1-Methylnicothinamide]', 'C7H9N2O'),
	...
	('3,4-Dihydroxybenzoate; Protocatechuic acid', 'C7H5O4'),
	...
	('3-[(4-Amino-2-methylpyrimidin-5-yl)methyl]-5-(2-hydroxyethyl)-4-methyl-1,3-thiazol-3-ium chloride [thiamine dichloride]', 'C12H17ClN4OS'),
	('4,5-Bis(hydroxymethyl)-2-methylpyridin-3-ol [pyridoxinde]', 'C8H11NO3'),
	...
	('Arsenite; should be Arsenic', 'AsO3'),
	...
	('L Cystine [L-Cystine]', 'C6H12N2O4S2'),
	...
	('L-Cystathionine [L-Cystine]', 'C7H14N2O4S'),
	('L-Cysteine', 'C3H7NO2S'),
	...
	('Menadione [Vitamin K (Menadione)]', 'C11H8O2'),
	('Mercury; Hg2+', 'Hg'),
	('Methanol', 'CH4O'),
...
INSERT INTO substance2db(substance_id, db_id, db_type) VALUES
	...
	((SELECT id FROM substance WHERE name='3-[(4-Amino-2-methylpyrimidin-5-yl)methyl]-5-(2-hydroxyethyl)-4-methyl-1,3-thiazol-3-ium chloride [Thiamine dichloride]'), 'thm', 'BiGG'),
	((SELECT id FROM substance WHERE name='4,5-Bis(hydroxymethyl)-2-methylpyridin-3-ol [Pyridoxinde]'), 'pydxn', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Dihydrogen [H2]'), 'h2', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Hydrosulfide'), 'HC00250', 'BiGG'),
	((SELECT id FROM substance WHERE name='Hydrosulfide'), 'MNXM162964', 'MetaNetX'),
	...
	((SELECT id FROM substance WHERE name='Nickel(II) cation [Ni2+]'), 'ni2', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Phylloquinone [Vitamin K1]'), 'phllqne, phyla', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Pyridine-3-carboxylate [Niacin]'), 'nac, nicnt', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='alpha-Linoleate'), 'lnlnca', 'BiGG'),
