...
INSERT INTO substance(name, formula) VALUES
	...
	('(R)-3-Hydroxybutanoate [(R)-3-Hydroxybutyric acid]', NULL),
	('(R)-Pantothenate [Ca-D-Pantothenic acid]', NULL),
	('(R)-Pantothenate [Calcium Pantothenate]', NULL),
	('(R)-Pantothenate [Pantothenic acid]', NULL),
	-- Substance names starting with '(S)'
	('(S)-3-Methyl-2-oxopentanoate [3-Methyl-2-Oxovaleric acid]', NULL),
	('(S)-Glycerate [L-Glyceric acid]', NULL),
	-- Substance names starting with a number [0-9]*
	('1 Methylnicotinamide [1-Methylnicothinamide]', NULL),
	('13Z)-13-docosenoic acid [Erucic acid]', NULL),
	('2 Hydroxybutyrate [2-Hydroxybutyric acid]', NULL),
	('2,2-Bipyridine', NULL),
	('2,3-Cyclic GMP [Cyclic GMP]', NULL),
	('2-Methylcitrate [2-Methylcitric acid]', NULL),
	('2-Oxoglutarate [Oxoglutaric acid]', NULL),
	('20alpha-Dihydroprogesterone [20a-Dihydroprogesterone]', NULL),
	('25-Hydroxyvitamin D2', NULL),
	('25-Hydroxyvitamin D3 [Calcidiol]', NULL),
	('3,4-Dihydroxy-L-phenylalanine [L-Dopa]', NULL),
	('3,4-Dihydroxybenzoate; Protocatechuic acid', NULL),
	('3,4-Dihydroxyphenylethyleneglycol [3,4-Dihydroxyphenylglycol]', NULL),
	('3,5-Cyclic GMP [Cyclic GMP]', NULL),
	('3-(4-Hydroxyphenyl)pyruvate [4-Hydroxyphenylpyruvic acid]', NULL),
	('3-Hydroxyhexadecanoylcarnithine', NULL),
	('3-Methyl-2-oxobutanoate [alpha-Ketoisovaleric acid]', NULL),
	('3-Methylimidazoleacetic acid [Methylimidazoleacetic acid]', NULL),
	('4-Aminobenzoate', NULL),
	('4-Aminobenzoate [p-Aminobenzoic acid]', NULL),
	('4-Aminobutanoate [gamma-Aminobutyric acid]', NULL),
	('4-Hydroxyphenylacetate [p-Hydroxyphenylacetic acid]', NULL),
	('4-Methyl-2-oxopentanoate [Ketoleucine]', NULL),
	('4-Pyridoxate [4-Pyridoxic acid]', NULL),
	('4hdebrisoquine [4-Hydroxydebrisoquine]', NULL),
	('5 Formyltetrahydrofolate [Folinic acid]', NULL),
	('5,6,7,8-Tetrahydrofolate [Tetrahydrofolic acid]', NULL),
	('5-Formyltetrahydrofolate [Folinic acid]', NULL),
	('5-Hydroxy-L-tryptophan', NULL),
	('5-Methyltetrahydrofolate [5-Methyltetrahydrofolic acid]', NULL),
	('5-Oxoproline [Pyroglutamic acid]', NULL),
	('5-Phospho-alpha-D-ribose 1-diphosphate [Phosphoribosyl pyrophosphate]', NULL),
	('5alpha-Dihydrotestosterone [Dihydrotestosterone]', NULL),
	('7,8-Dihydrofolate [Dihydrofolic acid]', NULL),
	('9-cis-retinol [Vitamin A]', NULL),
	-- Substance names starting with 'A'
	('ADP', NULL),
	('AMP', NULL),
	('AMP [Adenosine monophosphate]', NULL),
	('ATP [Adenosine triphosphate]', NULL),
	('Acetaldehyde', NULL),
	('Acetate [Acetic acid]', NULL),
	('Acetoacetate [Acetoacetic acid]', NULL),
	('Acetone', NULL),
	('Adenine', NULL),
	('Adenosine', NULL),
	('Adrenic acid', NULL),
	('Alanine', NULL),
	('All-trans-Retinal [Retinal]', NULL),
	('All-trans-Retinol [Vitamin A]', NULL),
	('Alpha linolenic acid [Alpha-Linolenic acid]', NULL),
	('Alpha-Linolenic acid', NULL),
	('Alpha-N-Phenylacetyl-L-glutamine', NULL),
	('Alpha-Tocopherol', NULL),
	('Alpha-Tocotrienol', NULL),
	('Ammonia', NULL),
	('Ammonium', NULL),
	('Ammonium [NH4Cl]', NULL),
	('Androsterone glucuronide', NULL),
	('Andrstrn [Androsterone]', NULL),
	('Anthranilate [2-Aminobenzoic acid]', NULL),
	('Arachidic acid', NULL),
	('Arachidonic acid', NULL),
	('Arginine', NULL),
	('Arsenite; should be Arsenic', NULL),
	('Aspartic acid', NULL),
	-- Substance names starting with 'B'
	('Behenate, Docosanoate [Behenic acid]', NULL),
	('Benzoate [Benzoic acid]', NULL),
	('Beta-Carotene [B-Carotene]', NULL),
	('Beta-Tocopherol', NULL),
	('Bicarbonate', NULL),
	('Bicarbonate [Hydrogen carbonate]', NULL),
	('Bicarbonate [NaHCO3]', NULL),
	('Billirubin', NULL),
	('Biotin', NULL),
	('Butyrate [Butyric acid]', NULL),
	('Butyryl carnitine', NULL),
	-- Substance names starting with 'C'
	('CAMP [Cyclic AMP]', NULL),
	('CDP', NULL),
	('CMP', NULL),
	('CO2', NULL),
	('CO2 [Carbon dioxide]', NULL),
	('Ca2+', NULL),
	('Cadmium', NULL),
	('Calciol; (+)-Vitamin D3 [Vitamin D3]', NULL),
	('Calcium', NULL),
	('Calcium [CaCl2 (anhydrous)]', NULL),
	('Calcium [CaCl2]', NULL),
	('Calcium; Ca2+', NULL),
	('Carbon monoxide', NULL),
	('Carbondioxide', NULL),
	('Cellobiose', NULL),
	('Cervonic acid [Docosahexaenoic acid]', NULL),
	('Chenodeoxycholate [Chenodeoxycholic acid]', NULL),
	('Chenodeoxyglycocholate [Chenodeoxycholic acid glycine conjugate]', NULL),
	('Chloride', NULL),
	('Chloride [Chloride ion]', NULL),
	('Chloride [NaCl]', NULL),
	('Chloride; Cl-', NULL),
	('Cholate [Cholic acid]', NULL),
	('Choline', NULL),
	('Chorismate', NULL),
	('Chromate', NULL),
	('Chsterol [Cholesterol]', NULL),
	('Citrate [Citric acid]', NULL),
	('Citrate [Sodium citrate (Na3C6H5O7.2H2O)]', NULL),
	('Cl-', NULL),
	('Co2+', NULL),
	('Co2+ [Co(NO3)2 . 6H2O]', NULL),
	('Co2+ [CoCl2]', NULL),
	('Cob(I)alamin [Cyanocobalamine]', NULL),
	('Cob(I)alamin [Vitamin B12]', NULL),
	('Cob(II)alamin [Cyanocobalamine]', NULL),
	('Cob(II)alamin [Vitamin B12]', NULL),
	('Copper', NULL),
	('Copper [CuCl2]', NULL),
	('Copper [CuSO4 (anhydrous)]', NULL),
	('Corticosterone', NULL),
	('Creatine', NULL),
	('Creatinine [C4H7N3O]', NULL),
	('Crtsl [Cortisol]', NULL),
	('Cu2+', NULL),
	('Cyanate', NULL),
	('Cys Gly [Cysteinylglycine]', NULL),
	('Cysteine', NULL),
	('Cytidine', NULL),
	('Cytosine', NULL),
	...
	('D-Galactose', NULL),
	('D-Glucose', NULL),
	('D-Lactate [D-Lactic acid]', NULL),
	('D-Malate', NULL),
	('D-Mannose', NULL),
	('D-Ribose', NULL),
	('D-Serine', NULL),
	('D-Sorbitol [Sorbitol]', NULL),
	('D-Xylose', NULL),
	('Debrisoquine', NULL),
	('Decanoate [Capric acid]', NULL),
	('Decanoyl Carnitine [Decanoylcarnithine]', NULL),
	('Dehydroascorbate [Dehydroascorbic acid]', NULL),
	('Dehydroepiandrosterone sulfate', NULL),
	('Deoxyadenosine', NULL),
	('Deoxycholate [Deoxycholic acid]', NULL),
	('Deoxycytidine', NULL),
	('Deoxyuridine', NULL),
	('Dihomo-gamma-linolenic acid [8,11,14-Eicosatrienoic acid]', NULL),
	('Dihydroxyacetone phosphate', NULL),
	('Diphosphate [Pyrophosphate]', NULL),
	('Dodecanoate [Dodecanoic acid]', NULL),
	('Dopamine 3-O-Sulfate', NULL),
	-- Substance names starting with 'E'
	('EDTA', NULL),
	('Eicosatetranoic acid [Cis-8,11,14,17-Eicosatetranoic acid]', NULL),
	('Elaidic acid', NULL),
	('Estrone sulfate', NULL),
	('Ethanol', NULL),
	-- Substance names starting with 'F'
	('FMN [Flavin Mononucleotide]', NULL),
	('Fe2+', NULL),
	('Fe2+ [FeSO4 . 7H2O]', NULL),
	('Fe3+', NULL),
	('Flavin adenine dinucleotide oxidized [FAD]', NULL),
	('Folate', NULL),
	('Folate [Folic acid]', NULL),
	('Formaldehyde', NULL),
	('Formate [Formic acid]', NULL),
	('Fructose', NULL),
	('Fumarate [Fumaric acid]', NULL),
	('Fumarate [Fumeric acid]', NULL),
	-- Substance names starting with 'G'
	('GDP [Guanosine diphosphate]', NULL),
	('GMP', NULL),
	('GMP [Guanosine monophosphate]', NULL),
	('GTP [Guanosine triphosphate]', NULL),
	('Gamma-Linolenic acid', NULL),
	('Globoside (homo sapiens) [Tetrahexosylceramide (d18:1/12:0)]', NULL),
	('Glucosamine', NULL),
	('Glucose', NULL),
	('Glucuronate [D-Glucuronic acid]', NULL),
	('Glutamate [Glutamic acid]', NULL),
	('Glutamic acid', NULL),
	('Glycerol', NULL),
	('Glycerol 3-phosphate', NULL),
	('Glycine', NULL),
	('Glycine betaine [Betaine]', NULL),
	('Glycocholate [Glycocholic acid]', NULL),
	('Glycolithocolate [Lithocholic acid glycine conjugate]', NULL),
	('Glycoursodeoxycholate [Glycoursodeoxycholic acid]', NULL),
	('Guanosine', NULL),
	...
	('H3BO3', NULL),
	('Heme D [Hematin]', NULL),
	('Heptadecanoate [Heptadecanoic acid]', NULL),
	('Hexacosanoate [Hexacosanoic acid]', NULL),
	('Hexadecanoate [Palmitic acid]', NULL),
	('Hexadecenoate [Palmitoleic acid]', NULL),
	('Histidine', NULL),
	('Hyaluronan [Hyaluronic acid]', NULL),
	('Hydrogen [KH2PO4]', NULL),
	('Hydrogen [NaH2PO4.2H2O]', NULL),
	('Hydrogen peroxide', NULL),
	('Hydrogen sulfide', NULL),
	('Hydrosulfide [Hydrogen sulfide]', NULL),
	('Hypoxanthine', NULL),
	-- Substance names starting with 'I'
	('IMP [Inosinic acid]', NULL),
	('Inosine', NULL),
	('Iron', NULL),
	('Iron (Fe2+)', NULL),
	('Iron (Fe3+)', NULL),
	('Isobutyrate [Butyric acid]', NULL),
	('Isobutyric acid [Butyric acid]', NULL),
	('Isoleucine', NULL),
	('Isovalerate [Isovaleric acid]', NULL),
	('Isovaleryl Carnitine', NULL),
	-- Substance names starting with 'K'
	('K+', NULL),
	-- Substance names starting with 'L'
	('L Arabinitol [L-Arabitol]', NULL),
	('L Cystine [L-Cystine]', NULL),
	('L-3-Amino-isobutanoate [(S)-b-aminoisobutyric acid]', NULL),
	('L-Alanine', NULL),
	('L-Arabinose', NULL),
	('L-Arginine', NULL),
	('L-Ascorbate [Ascorbic acid]', NULL),
	('L-Asparagine', NULL),
	('L-Aspartate', NULL),
	('L-Aspartate [L-Aspartic acid]', NULL),
	('L-Carnitine', NULL),
	('L-Carnosine [Carnosine]', NULL),
	('L-Citrulline [Citrulline]', NULL),
	('L-Cystathionine [L-Cystine]', NULL),
	('L-Cysteine', NULL),
	('L-Glutamate', NULL),
	('L-Glutamate [L-Glutamic acid]', NULL),
	('L-Glutamine', NULL),
	('L-Histidine', NULL),
	('L-Homoserine', NULL),
	('L-Isoleucine', NULL),
	('L-Lactate [L-Lactic acid]', NULL),
	('L-Leucine', NULL),
	('L-Lysine', NULL),
	('L-Malate [L-Malic acid]', NULL),
	('L-Methionine', NULL),
	('L-Phenylalanine', NULL),
	('L-Proline', NULL),
	('L-Serine', NULL),
	('L-Sorbitol [Sorbitol]', NULL),
	('L-Threonine', NULL),
	('L-Thyroxine [Thyroxine]', NULL),
	('L-Tryptophan', NULL),
	('L-Tyrosine', NULL),
	('L-Tyrosine disodium salt dihydrate', NULL),
	('L-Valine', NULL),
	('Lead', NULL),
	('Leucine', NULL),
	('Lignoceric acid [Tetracosanoic acid]', NULL),
	('Lignoceric acid or tetracosanoicacid [Tetracosanoic acid]', NULL),
	('Limnen (D-Limonene)', NULL),
	('Linoleic acid', NULL),
	('Lipoate', NULL),
	('Lipoate (protein bound) [Lipoic acid]', NULL),
	('Lipoate [(R)-lipoic acid]', NULL),
	('Lipoate [Lipoic acid]', NULL),
	('Lithocholate [Lithocholic acid]', NULL),
	('Lysine', NULL),
	-- Substance names starting with 'M'
	('Magnesium', NULL),
	('Magnesium [MgSO4 * 7H2O]', NULL),
	('Magnesium [MgSO4.7H2O]', NULL),
	('Malate [Maleic acid]', NULL),
	('Maltose', NULL),
	('Manganese', NULL),
	('Manganese [MnCl2]', NULL),
	('Manganese [MnSO4 * H2O]', NULL),
	('Menadione [Vitamin K (menadione)]', NULL),
	('Mercury; Hg2+', NULL),
	('Metanephrine', NULL),
	('Methanol', NULL),
	('Methionine', NULL),
	('Methylglyoxal [Pyruvaldehyde]', NULL),
	('Mg', NULL),
	('Mn2+', NULL),
	('Molybdate', NULL),
	('Molybdate [MoNa2O4]', NULL),
	('Molybdate [Na2MoO4 . 2H2O]', NULL),
	('Myo-Inositol', NULL),
	('Myo-Inositol; should be I-Inositol', NULL),
	...
	('Niacinamide', NULL),
	('Nickel', NULL),
	('Nickel [NiCl2 . 6H2O]', NULL),
	('Nickel [NiCl2]', NULL),
	('Nicotinamide adenine dinucleotide [NAD]', NULL),
	('Nicotinamide adenine dinucleotide phosphate [NADP]', NULL),
	('Nicotinate [Niacin]', NULL),
	('Nicotinate [Nicotinic acid]', NULL),
	('Nicotinic acid', NULL),
	('Nitrate', NULL),
	('Nitrate [Co(NO3)2 . 6H2O]', NULL),
	('Nitrite', NULL),
	('Nitrogen', NULL),
	('Norepinephrine', NULL),
	...
	('O2', NULL),
	('O2 [Oxygen]', NULL),
	('Octadecanoate [Stearic acid]', NULL),
	('Octadecenoate [Oleic acid]', NULL),
	('Octanoate [Caprylic acid]', NULL),
	('Octanoyl carnitine [L-Octanoylcarnitine]', NULL),
	('Octenoyl Carnithine [2-Octenoylcarnithine]', NULL),
	('Ornithine', NULL),
	('Orotate [Orotic acid]', NULL),
	('Oxalate [Oxalic acid]', NULL),
	('Oxalate [Potassium Oxalate (K2C2O4.H2O)]', NULL),
	('Oxidized glutathione', NULL),
	('Oxygen', NULL),
	-- Substance names starting with 'P'
	('Pantothenic acid; (R)-Pantothenate', NULL),
	('Pentadecanoate [Pentadecanoic acid]', NULL),
	('Phenol Red', NULL),
	('Phenylalanine', NULL),
	('Phosphate', NULL),
	('Phosphate [KH2PO4]', NULL),
	('Phosphate [NaH2PO4.2H2O]', NULL),
	('Phylloquinone (old identifier for [Vitamin K1])', NULL),
	('Phylloquinone [Vitamin K1]', NULL),
	('Phytanic acid', NULL),
	('Potassium', NULL),
	('Potassium [AlK(SO4)2 (anhydrous)]', NULL),
	('Potassium [KCl]', NULL),
	('Potassium; K+', NULL),
	('Prgstrn [Progesterone]', NULL),
	('Proline', NULL),
	('Propionate [Propionic acid]', NULL),
	('Protoheme', NULL),
	('Putrescine', NULL),
	('Pyridoxal', NULL),
	('Pyridoxal 5-phosphate', NULL),
	('Pyridoxamine', NULL),
	('Pyridoxamine [Pyridoxamine-2HCl]', NULL),
	('Pyridoxine', NULL),
	('Pyridoxine [Pyridoxine HCl]', NULL),
	('Pyruvate [Pyruvic acid]', NULL),
	-- Substance names starting with 'R'
	('R-Pantothenate', NULL),
	('Reduced glutathione', NULL),
	('Reduced glutathione [Glutathione]', NULL),
	('Resazurin', NULL),
	('Retinoate [All-trans-retinoic acid]', NULL),
	('Retinoyl glucuronide [Retinoyl b-glucuronide]', NULL),
	('Ribitol', NULL),
	('Riboflavin', NULL),
	-- Substance names starting with 'S'
	('Sarcosine', NULL),
	('Selenite [Na2SeO3 (anhydrous)]', NULL),
	('Selenium', NULL),
	('Serine', NULL),
	('Serotonin', NULL),
	('Sodium', NULL),
	...
	('Spermidine', NULL),
	('Spermine', NULL),
	('Sphinganine 1 phosphate [Sphinganine 1-phosphate]', NULL),
	('Sphingosine 1-phosphate', NULL),
	('Stearidonic acid', NULL),
	('Succinate [Succinic acid]', NULL),
	('Sucrose', NULL),
	('Sulfate', NULL),
	('Sulfate [FeSO4 . 7H2O]', NULL),
	('Sulfate [Na2SO4]', NULL),
	('Sulfate derivative of norepinephrine [Norepinephrine sulfate]', NULL),
	('Sulfite', NULL),
	('Sulfoglycolithocholate [Sulfolithocholylglycine]', NULL),
	('Sulphate', NULL),
	-- Substance names starting with 'T'
	('Taurine', NULL),
	('Taurochenodeoxycholate [Taurochenodesoxycholic acid]', NULL),
	('Taurocholic acid', NULL),
	('Taurodeoxycholate [Taurodeoxycholic acid]', NULL),
	('Taurolithocholate [Lithocholyltaurine]', NULL),
	('Tetradecanoate [Myristic acid]', NULL),
	('Thiamin', NULL),
	('Thiamin [Thiamine HCl]', NULL),
	('Thiamin [Thiamine-dichloride]', NULL),
	('Thiamin [Thiamine]', NULL),
	('Thiocyanate', NULL),
	('Thiosulfate', NULL),
	('Threonine', NULL),
	('Thromboxane-b2 [Thromboxane B2]', NULL),
	('Thymidine', NULL),
	('Timnodonic acid [Eicosapentaenoic acid]', NULL),
	('Trans-4-Hydroxy-L-proline', NULL),
	('Tryptophane', NULL),
	('Tststerone [Testosterone]', NULL),
	('Tungstate [Na2WO4 . 2H2O]', NULL),
	('Tyrosine', NULL),
	-- Substance names starting with 'U'
	('UDP [Uridine 5-diphosphate]', NULL),
	('UDPglucose [Uridine diphosphate glucose]', NULL),
	('UMP', NULL),
	('UMP [Uridine 5-monophosphate]', NULL),
	('Ubiquinone-10', NULL),
	('Uracil', NULL),
	('Urate [Uric acid (C5H4N4O3)]', NULL),
	('Urate [Uric acid]', NULL),
	('Urea', NULL),
	('Urea [CH4N2O]', NULL),
	('Urea; Carbamide', NULL),
	('Uridine', NULL),
	('Ursodeoxycholate [Ursodeoxycholic acid]', NULL),
	-- Substance names starting with 'V'
	('Vaccenic acid', NULL),
	('Valeric acid [Isovaleric acid]', NULL),
	('Valine', NULL),
	('Vitamin B12', NULL),
	('Vitamin B12 [Cyanocobalamine]', NULL),
	('Vitamin D2; Ergocalciferol', NULL),
	-- Substance names starting with 'W'
	('Water', NULL),
	-- Substance names starting with 'X'
	('Xanthurenic acid', NULL),
	('Xylitol [D-Xylitol]', NULL),
	-- Substance names starting with 'Z'
	('Zinc', NULL),
	('Zinc [ZnCl2]', NULL),
	('Zinc [ZnSO4 * 7H2O]', NULL),
	('Zinc; Zn2+', NULL),
	-- Substance names starting with 'beta'
	('beta-Alanine', NULL);
...
INSERT INTO substance2db(substance_id, db_id, db_type) VALUES
	...
	((SELECT id FROM substance WHERE name='(R)-Pantothenate [Ca-D-Pantothenic acid]'), 'pnto__R', 'BiGG'),
	((SELECT id FROM substance WHERE name='(R)-Pantothenate [Calcium Pantothenate]'), 'pnto__R', 'BiGG'),
	((SELECT id FROM substance WHERE name='(R)-Pantothenate [Pantothenic acid]'), 'pnto__R', 'BiGG'),
	-- Substance names starting with '(S)'
	((SELECT id FROM substance WHERE name='(S)-3-Methyl-2-oxopentanoate [3-Methyl-2-Oxovaleric acid]'), '3mop', 'BiGG'),
	((SELECT id FROM substance WHERE name='(S)-Glycerate [L-Glyceric acid]'), 'glyc__S', 'BiGG'),
	-- Substance names starting with a number [0-9]*
	((SELECT id FROM substance WHERE name='1 Methylnicotinamide [1-Methylnicothinamide]'), '1mncam', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='20alpha-Dihydroprogesterone [20a-Dihydroprogesterone]'), 'aprgstrn', 'BiGG'),
	((SELECT id FROM substance WHERE name='25-Hydroxyvitamin D2'), '25hvitd2', 'BiGG'),
	((SELECT id FROM substance WHERE name='25-Hydroxyvitamin D3 [Calcidiol]'), '25hvitd3', 'BiGG'),
	((SELECT id FROM substance WHERE name='3,4-Dihydroxy-L-phenylalanine [L-Dopa]'), '34dhphe', 'BiGG'),
	((SELECT id FROM substance WHERE name='3,4-Dihydroxybenzoate; Protocatechuic acid'), '34dhbz', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='3-Methylimidazoleacetic acid [Methylimidazoleacetic acid]'), '3mlda', 'BiGG'),
	((SELECT id FROM substance WHERE name='4-Aminobenzoate'), '4abz', 'BiGG'),
	((SELECT id FROM substance WHERE name='4-Aminobenzoate [p-Aminobenzoic acid]'), '4abz', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='4-Pyridoxate [4-Pyridoxic acid]'), '4pyrdx', 'BiGG'),
	((SELECT id FROM substance WHERE name='4hdebrisoquine [4-Hydroxydebrisoquine]'), '4hdebrisoquine', 'BiGG'),
	((SELECT id FROM substance WHERE name='5 Formyltetrahydrofolate [Folinic acid]'), '5fothf', 'BiGG'),
	((SELECT id FROM substance WHERE name='5,6,7,8-Tetrahydrofolate [Tetrahydrofolic acid]'), 'thf', 'BiGG'),
	((SELECT id FROM substance WHERE name='5-Formyltetrahydrofolate [Folinic acid]'), '5fthf', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='5alpha-Dihydrotestosterone [Dihydrotestosterone]'), '5adtststerone', 'BiGG'),
	((SELECT id FROM substance WHERE name='7,8-Dihydrofolate [Dihydrofolic acid]'), 'dhf', 'BiGG'),
	((SELECT id FROM substance WHERE name='9-cis-retinol [Vitamin A]'), 'retinol_9_cis', 'BiGG'),
	-- Substance names starting with 'A'
	((SELECT id FROM substance WHERE name='ADP'), 'adp', 'BiGG'),
	((SELECT id FROM substance WHERE name='AMP'), 'amp', 'BiGG'),
	((SELECT id FROM substance WHERE name='AMP [Adenosine monophosphate]'), 'amp', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Adrenic acid'), 'adrn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Alanine'), 'ala__L', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Alpha linolenic acid [Alpha-Linolenic acid]'), 'alpla', 'BiGG'),
	((SELECT id FROM substance WHERE name='Alpha-Linolenic acid'), 'lnlnca', 'BiGG'),
	((SELECT id FROM substance WHERE name='Alpha-N-Phenylacetyl-L-glutamine'), 'pheacgln', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Ammonium'), 'nh4', 'BiGG'),
	((SELECT id FROM substance WHERE name='Ammonium [NH4Cl]'), 'nh4', 'BiGG'),
	((SELECT id FROM substance WHERE name='Androsterone glucuronide'), 'andrstrnglc', 'BiGG'),
	((SELECT id FROM substance WHERE name='Andrstrn [Androsterone]'), 'andrstrn', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Arachidonic acid'), 'arachd', 'BiGG'),
	((SELECT id FROM substance WHERE name='Arginine'), 'arg__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Arsenite; should be Arsenic'), 'aso3', 'BiGG'),
	((SELECT id FROM substance WHERE name='Aspartic acid'), 'asp__L', 'BiGG'),
	-- Substance names starting with 'B'
	((SELECT id FROM substance WHERE name='Behenate, Docosanoate [Behenic acid]'), 'docosac', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Bicarbonate'), 'hco3', 'BiGG'),
	((SELECT id FROM substance WHERE name='Bicarbonate [Hydrogen carbonate]'), 'hco3', 'BiGG'),
	((SELECT id FROM substance WHERE name='Bicarbonate [NaHCO3]'), 'hco3', 'BiGG'),
	((SELECT id FROM substance WHERE name='Billirubin'), 'bilirub', 'BiGG'),
	((SELECT id FROM substance WHERE name='Biotin'), 'btn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Butyrate [Butyric acid]'), 'but', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='CO2'), 'co2', 'BiGG'),
	((SELECT id FROM substance WHERE name='CO2 [Carbon dioxide]'), 'co2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Ca2+'), 'ca2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Cadmium'), 'cd2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Calciol; (+)-Vitamin D3 [Vitamin D3]'), 'vitd3', 'BiGG'),
	((SELECT id FROM substance WHERE name='Calcium'), 'ca2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Calcium [CaCl2 (anhydrous)]'), 'ca2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Calcium [CaCl2]'), 'ca2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Calcium; Ca2+'), 'ca2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Carbon monoxide'), 'co', 'BiGG'),
	((SELECT id FROM substance WHERE name='Carbondioxide'), 'co2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Cellobiose'), 'cellb', 'BiGG'),
	((SELECT id FROM substance WHERE name='Cervonic acid [Docosahexaenoic acid]'), 'crvnc', 'BiGG'),
	((SELECT id FROM substance WHERE name='Chenodeoxycholate [Chenodeoxycholic acid]'), 'C02528', 'BiGG'),
	((SELECT id FROM substance WHERE name='Chenodeoxyglycocholate [Chenodeoxycholic acid glycine conjugate]'), 'dgchol', 'BiGG'),
	((SELECT id FROM substance WHERE name='Chloride'), 'cl', 'BiGG'),
	((SELECT id FROM substance WHERE name='Chloride [Chloride ion]'), 'cl', 'BiGG'),
	((SELECT id FROM substance WHERE name='Chloride [NaCl]'), 'cl', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Chsterol [Cholesterol]'), 'chsterol', 'BiGG'),
	((SELECT id FROM substance WHERE name='Citrate [Citric acid]'), 'cit', 'BiGG'),
	((SELECT id FROM substance WHERE name='Citrate [Sodium citrate (Na3C6H5O7.2H2O)]'), 'cit', 'BiGG'),
	((SELECT id FROM substance WHERE name='Cl-'), 'cl', 'BiGG'),
	((SELECT id FROM substance WHERE name='Co2+'), 'cobalt2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Co2+ [Co(NO3)2 . 6H2O]'), 'cobalt2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Co2+ [CoCl2]'), 'cobalt2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Cob(I)alamin [Cyanocobalamine]'), 'cbl1', 'BiGG'),
	((SELECT id FROM substance WHERE name='Cob(I)alamin [Vitamin B12]'), 'cbl1', 'BiGG'),
	((SELECT id FROM substance WHERE name='Cob(II)alamin [Cyanocobalamine]'), 'cbl2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Cob(II)alamin [Vitamin B12]'), 'cbl2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Copper'), 'cu2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Copper [CuCl2]'), 'cu2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Copper [CuSO4 (anhydrous)]'), 'cu2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Corticosterone'), 'crtstrn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Creatine'), 'creat', 'BiGG'),
	((SELECT id FROM substance WHERE name='Creatinine [C4H7N3O]'), 'crtn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Crtsl [Cortisol]'), 'crtsl', 'BiGG'),
	((SELECT id FROM substance WHERE name='Cu2+'), 'cu2', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Cysteine'), 'cys__L', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='D-Malate'), 'mal__D', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Decanoate [Capric acid]'), 'dca', 'BiGG'),
	((SELECT id FROM substance WHERE name='Decanoyl Carnitine [Decanoylcarnithine]'), 'c10crn', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Dihomo-gamma-linolenic acid [8,11,14-Eicosatrienoic acid]'), 'dlnlcg', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Dodecanoate [Dodecanoic acid]'), 'ddca', 'BiGG'),
	((SELECT id FROM substance WHERE name='Dopamine 3-O-Sulfate'), 'dopasf', 'BiGG'),
	-- Substance names starting with 'E'
	((SELECT id FROM substance WHERE name='EDTA'), 'C00284', 'KEGG'),
	((SELECT id FROM substance WHERE name='EDTA'), 'cpd00240', 'SEED'),
	((SELECT id FROM substance WHERE name='Eicosatetranoic acid [Cis-8,11,14,17-Eicosatetranoic acid]'), 'eicostet', 'BiGG'),
	((SELECT id FROM substance WHERE name='Elaidic acid'), 'elaid', 'BiGG'),
	((SELECT id FROM substance WHERE name='Estrone sulfate'), 'estrones', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Fe2+'), 'fe2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Fe2+ [FeSO4 . 7H2O]'), 'fe2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Fe3+'), 'fe3', 'BiGG'),
	((SELECT id FROM substance WHERE name='Flavin adenine dinucleotide oxidized [FAD]'), 'fad', 'BiGG'),
	((SELECT id FROM substance WHERE name='Folate'), 'fol', 'BiGG'),
	((SELECT id FROM substance WHERE name='Folate [Folic acid]'), 'fol', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Fructose'), 'fru', 'BiGG'),
	((SELECT id FROM substance WHERE name='Fumarate [Fumaric acid]'), 'fum', 'BiGG'),
	((SELECT id FROM substance WHERE name='Fumarate [Fumeric acid]'), 'fum', 'BiGG'),
	-- Substance names starting with 'G'
	((SELECT id FROM substance WHERE name='GDP [Guanosine diphosphate]'), 'gdp', 'BiGG'),
	((SELECT id FROM substance WHERE name='GMP'), 'gmp', 'BiGG'),
	((SELECT id FROM substance WHERE name='GMP [Guanosine monophosphate]'), 'gmp', 'BiGG'),
	((SELECT id FROM substance WHERE name='GTP [Guanosine triphosphate]'), 'gtp', 'BiGG'),
	((SELECT id FROM substance WHERE name='Gamma-Linolenic acid'), 'lnlncg', 'BiGG'),
	((SELECT id FROM substance WHERE name='Globoside (homo sapiens) [Tetrahexosylceramide (d18:1/12:0)]'), 'gbside_hs', 'BiGG'),
	((SELECT id FROM substance WHERE name='Glucosamine'), 'gam', 'BiGG'),
	((SELECT id FROM substance WHERE name='Glucose'), 'glc__D', 'BiGG'),
	((SELECT id FROM substance WHERE name='Glucose'), 'glc__bD', 'BiGG'),
	((SELECT id FROM substance WHERE name='Glucuronate [D-Glucuronic acid]'), 'glcur', 'BiGG'),
	((SELECT id FROM substance WHERE name='Glutamate [Glutamic acid]'), 'glu__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Glutamic acid'), 'glu__L', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Glycocholate [Glycocholic acid]'), 'gchola', 'BiGG'),
	...
	-- Substance names starting with 'H'
	((SELECT id FROM substance WHERE name='H+'), 'h', 'BiGG'),
	((SELECT id FROM substance WHERE name='H+ [Na2HPO4.2H2O]'), 'h', 'BiGG'),
	((SELECT id FROM substance WHERE name='H+ [Protons]'), 'h', 'BiGG'),
	((SELECT id FROM substance WHERE name='H+; Hydrogen'), 'h', 'BiGG'),
	((SELECT id FROM substance WHERE name='H2O'), 'h2o', 'BiGG'),
	((SELECT id FROM substance WHERE name='H2O [FeSO4 . 7H2O]'), 'h2o', 'BiGG'),
	((SELECT id FROM substance WHERE name='H2O [Water]'), 'h2o', 'BiGG'),
	((SELECT id FROM substance WHERE name='Heme D [Hematin]'), 'hemeD', 'BiGG'),
	((SELECT id FROM substance WHERE name='Heptadecanoate [Heptadecanoic acid]'), 'hpdca', 'BiGG'),
	((SELECT id FROM substance WHERE name='Hexacosanoate [Hexacosanoic acid]'), 'hexc', 'BiGG'),
	((SELECT id FROM substance WHERE name='Hexadecanoate [Palmitic acid]'), 'hdca', 'BiGG'),
	((SELECT id FROM substance WHERE name='Hexadecenoate [Palmitoleic acid]'), 'hdcea', 'BiGG'),
	((SELECT id FROM substance WHERE name='Histidine'), 'his__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Hyaluronan [Hyaluronic acid]'), 'ha', 'BiGG'),
	((SELECT id FROM substance WHERE name='Hydrogen [KH2PO4]'), 'h2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Hydrogen [NaH2PO4.2H2O]'), 'h2', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Hydrosulfide [Hydrogen sulfide]'), 'HC00250', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Iron'), 'fe2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Iron (Fe2+)'), 'fe2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Iron (Fe3+)'), 'fe3', 'BiGG'),
	((SELECT id FROM substance WHERE name='Isobutyrate [Butyric acid]'), 'ibt', 'BiGG'),
	((SELECT id FROM substance WHERE name='Isobutyric acid [Butyric acid]'), 'isobuta', 'BiGG'),
	((SELECT id FROM substance WHERE name='Isoleucine'), 'ile__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Isovalerate [Isovaleric acid]'), 'ival', 'BiGG'),
	((SELECT id FROM substance WHERE name='Isovaleryl Carnitine'), 'ivcrn', 'BiGG'),
	-- Substance names starting with 'K'
	((SELECT id FROM substance WHERE name='K+'), 'k', 'BiGG'),
	-- Substance names starting with 'L'
	...
	((SELECT id FROM substance WHERE name='L Cystine [L-Cystine]'), 'cysi__L', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='L-Aspartate [L-Aspartic acid]'), 'asp__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Carnitine'), 'crn', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Carnosine [Carnosine]'), 'carn', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Citrulline [Citrulline]'), 'citr__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Cystathionine [L-Cystine]'), 'cyst__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Cysteine'), 'cys__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Glutamate'), 'glu__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Glutamate [L-Glutamic acid]'), 'glu__L', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='L-Thyroxine [Thyroxine]'), 'thyox__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Tryptophan'), 'trp__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Tyrosine'), 'tyr__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Tyrosine disodium salt dihydrate'), 'tyr__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='L-Valine'), 'val__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lead'), 'pb', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lead'), 'pb2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Leucine'), 'leu__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lignoceric acid [Tetracosanoic acid]'), 'lgnc', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lignoceric acid or tetracosanoicacid [Tetracosanoic acid]'), 'lgn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Limnen (D-Limonene)'), 'limnen', 'BiGG'),
	((SELECT id FROM substance WHERE name='Linoleic acid'), 'lnlc', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lipoate'), 'lipoate', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lipoate (protein bound) [Lipoic acid]'), 'lipopb', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lipoate [(R)-lipoic acid]'), 'lipt', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lipoate [(R)-lipoic acid]'), 'lipoate', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lipoate [Lipoic acid]'), 'lipoate', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lithocholate [Lithocholic acid]'), 'HC02191', 'BiGG'),
	((SELECT id FROM substance WHERE name='Lysine'), 'lys__L', 'BiGG'),
	-- Substance names starting with 'M'
	((SELECT id FROM substance WHERE name='Magnesium'), 'mg2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Magnesium [MgSO4 * 7H2O]'), 'mg2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Magnesium [MgSO4.7H2O]'), 'mg2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Malate [Maleic acid]'), 'male', 'BiGG'),
	((SELECT id FROM substance WHERE name='Maltose'), 'malt', 'BiGG'),
	((SELECT id FROM substance WHERE name='Manganese'), 'mn2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Manganese [MnCl2]'), 'mn2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Manganese [MnSO4 * H2O]'), 'mn2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Menadione [Vitamin K (menadione)]'), 'mndn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Mercury; Hg2+'), 'hg2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Metanephrine'), 'mepi', 'BiGG'),
	((SELECT id FROM substance WHERE name='Methanol'), 'meoh', 'BiGG'),
	((SELECT id FROM substance WHERE name='Methionine'), 'met__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Methylglyoxal [Pyruvaldehyde]'), 'mthgxl', 'BiGG'),
	((SELECT id FROM substance WHERE name='Mg'), 'mg2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Mn2+'), 'mn2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Molybdate'), 'mobd', 'BiGG'),
	((SELECT id FROM substance WHERE name='Molybdate [MoNa2O4]'), 'mobd', 'BiGG'),
	((SELECT id FROM substance WHERE name='Molybdate [Na2MoO4 . 2H2O]'), 'mobd', 'BiGG'),
	((SELECT id FROM substance WHERE name='Myo-Inositol'), 'inost', 'BiGG'),
	((SELECT id FROM substance WHERE name='Myo-Inositol; should be I-Inositol'), 'inost', 'BiGG'),
	-- Substance names starting with 'N'
	((SELECT id FROM substance WHERE name='Na+'), 'na1', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nervonic acid'), 'nrvnc', 'BiGG'),
	((SELECT id FROM substance WHERE name='Ni2+'), 'ni2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Niacinamide'), 'ncam', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nickel'), 'ni2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nickel [NiCl2 . 6H2O]'), 'ni2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nickel [NiCl2]'), 'ni2', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Nicotinate [Niacin]'), 'nac', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nicotinate [Niacin]'), 'nicnt', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nicotinate [Nicotinic acid]'), 'nac', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nicotinate [Nicotinic acid]'), 'nicnt', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nicotinic acid'), 'nac', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nitrate'), 'no3', 'BiGG'),
	((SELECT id FROM substance WHERE name='Nitrate [Co(NO3)2 . 6H2O]'), 'no3', 'BiGG'),
	...
	-- Substance names starting with 'O'
	((SELECT id FROM substance WHERE name='O2'), 'o2', 'BiGG'),
	((SELECT id FROM substance WHERE name='O2 [Oxygen]'), 'o2', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Octenoyl Carnithine [2-Octenoylcarnithine]'), 'c81crn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Ornithine'), 'orn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Orotate [Orotic acid]'), 'orot', 'BiGG'),
	((SELECT id FROM substance WHERE name='Oxalate [Oxalic acid]'), 'oxa', 'BiGG'),
	((SELECT id FROM substance WHERE name='Oxalate [Potassium Oxalate (K2C2O4.H2O)]'), 'oxa', 'BiGG'),
	((SELECT id FROM substance WHERE name='Oxidized glutathione'), 'gthox', 'BiGG'),
	((SELECT id FROM substance WHERE name='Oxygen'), 'o2', 'BiGG'),
	-- Substance names starting with 'P'
	((SELECT id FROM substance WHERE name='Pantothenic acid; (R)-Pantothenate'), 'pnto__R', 'BiGG'),
	((SELECT id FROM substance WHERE name='Pentadecanoate [Pentadecanoic acid]'), 'ptdca', 'BiGG'),
	((SELECT id FROM substance WHERE name='Phenol Red'), 'C12600', 'KEGG'),
	((SELECT id FROM substance WHERE name='Phenol Red'), 'cpd09248', 'SEED'),
	((SELECT id FROM substance WHERE name='Phenylalanine'), 'phe__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Phosphate'), 'pi', 'BiGG'),
	((SELECT id FROM substance WHERE name='Phosphate [KH2PO4]'), 'pi', 'BiGG'),
	((SELECT id FROM substance WHERE name='Phosphate [NaH2PO4.2H2O]'), 'pi', 'BiGG'),
	((SELECT id FROM substance WHERE name='Phylloquinone (old identifier for [Vitamin K1])'), 'phyQ', 'BiGG'),
	((SELECT id FROM substance WHERE name='Phylloquinone [Vitamin K1]'), 'phllqne', 'BiGG'),
	((SELECT id FROM substance WHERE name='Phytanic acid'), 'phyt', 'BiGG'),
	((SELECT id FROM substance WHERE name='Potassium'), 'k', 'BiGG'),
	((SELECT id FROM substance WHERE name='Potassium [AlK(SO4)2 (anhydrous)]'), 'k', 'BiGG'),
	((SELECT id FROM substance WHERE name='Potassium [KCl]'), 'k', 'BiGG'),
	((SELECT id FROM substance WHERE name='Potassium; K+'), 'k', 'BiGG'),
	((SELECT id FROM substance WHERE name='Prgstrn [Progesterone]'), 'prgstrn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Proline'), 'pro__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Propionate [Propionic acid]'), 'ppa', 'BiGG'),
	((SELECT id FROM substance WHERE name='Protoheme'), 'pheme', 'BiGG'),
	((SELECT id FROM substance WHERE name='Putrescine'), 'ptrc', 'BiGG'),
	((SELECT id FROM substance WHERE name='Pyridoxal'), 'pydx', 'BiGG'),
	((SELECT id FROM substance WHERE name='Pyridoxal 5-phosphate'), 'pydx5p', 'BiGG'),
	((SELECT id FROM substance WHERE name='Pyridoxamine'), 'pydam', 'BiGG'),
	((SELECT id FROM substance WHERE name='Pyridoxamine [Pyridoxamine-2HCl]'), 'pydam', 'BiGG'),
	((SELECT id FROM substance WHERE name='Pyridoxine'), 'pydxn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Pyridoxine'), 'pydx', 'BiGG'),
	((SELECT id FROM substance WHERE name='Pyridoxine [Pyridoxine HCl]'), 'pydxn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Pyruvate [Pyruvic acid]'), 'pyr', 'BiGG'),
	-- Substance names starting with 'R'
	((SELECT id FROM substance WHERE name='R-Pantothenate'), 'pnto__R', 'BiGG'),
	((SELECT id FROM substance WHERE name='Reduced glutathione'), 'gthrd', 'BiGG'),
	((SELECT id FROM substance WHERE name='Reduced glutathione [Glutathione]'), 'gthrd', 'BiGG'),
	((SELECT id FROM substance WHERE name='Resazurin'), 'C11178', 'KEGG'),
	((SELECT id FROM substance WHERE name='Resazurin'), 'cpd08053', 'SEED'),
	((SELECT id FROM substance WHERE name='Retinoate [All-trans-retinoic acid]'), 'retn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Retinoyl glucuronide [Retinoyl b-glucuronide]'), 'retnglc', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Selenite [Na2SeO3 (anhydrous)]'), 'slnt', 'BiGG'),
	((SELECT id FROM substance WHERE name='Selenium'), 'sel', 'BiGG'),
	((SELECT id FROM substance WHERE name='Selenium'), 'slnt', 'BiGG'),
	((SELECT id FROM substance WHERE name='Selenium'), 'seln', 'BiGG'),
	((SELECT id FROM substance WHERE name='Serine'), 'ser__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Serotonin'), 'srtn', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sodium'), 'na1', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sodium [NaCl]'), 'na1', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sodium; Na+'), 'na1', 'BiGG'),
	((SELECT id FROM substance WHERE name='Spermidine'), 'spmd', 'BiGG'),
	((SELECT id FROM substance WHERE name='Spermine'), 'sprm', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sphinganine 1 phosphate [Sphinganine 1-phosphate]'), 'sph1p', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sphingosine 1-phosphate'), 'sphs1p', 'BiGG'),
	((SELECT id FROM substance WHERE name='Stearidonic acid'), 'strdnc', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Sulfate'), 'so4', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sulfate [FeSO4 . 7H2O]'), 'so4', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sulfate [Na2SO4]'), 'so4', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sulfate derivative of norepinephrine [Norepinephrine sulfate]'), 'nrpphrsf', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sulfite'), 'so3', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sulfoglycolithocholate [Sulfolithocholylglycine]'), 'HC02197', 'BiGG'),
	((SELECT id FROM substance WHERE name='Sulphate'), 'so4', 'BiGG'),
	-- Substance names starting with 'T'
	...
	((SELECT id FROM substance WHERE name='Tetradecanoate [Myristic acid]'), 'ttdca', 'BiGG'),
	((SELECT id FROM substance WHERE name='Thiamin'), 'thm', 'BiGG'),
	((SELECT id FROM substance WHERE name='Thiamin [Thiamine HCl]'), 'thm', 'BiGG'),
	((SELECT id FROM substance WHERE name='Thiamin [Thiamine-dichloride]'), 'thm', 'BiGG'),
	((SELECT id FROM substance WHERE name='Thiamin [Thiamine]'), 'thm', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Threonine'), 'thr__L', 'BiGG'),
	...
	((SELECT id FROM substance WHERE name='Timnodonic acid [Eicosapentaenoic acid]'), 'tmndnc', 'BiGG'),
	((SELECT id FROM substance WHERE name='Trans-4-Hydroxy-L-proline'), '4hpro_LT', 'BiGG'),
	((SELECT id FROM substance WHERE name='Tryptophane'), 'trp__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Tststerone [Testosterone]'), 'tststerone', 'BiGG'),
	((SELECT id FROM substance WHERE name='Tungstate [Na2WO4 . 2H2O]'), 'tungs', 'BiGG'),
	((SELECT id FROM substance WHERE name='Tyrosine'), 'tyr__L', 'BiGG'),
	-- Substance names starting with 'U'
	...
	((SELECT id FROM substance WHERE name='UMP'), 'ump', 'BiGG'),
	((SELECT id FROM substance WHERE name='UMP [Uridine 5-monophosphate]'), 'ump', 'BiGG'),
	((SELECT id FROM substance WHERE name='Ubiquinone-10'), 'q10', 'BiGG'),
	((SELECT id FROM substance WHERE name='Uracil'), 'ura', 'BiGG'),
	((SELECT id FROM substance WHERE name='Urate [Uric acid (C5H4N4O3)]'), 'urate', 'BiGG'),
	((SELECT id FROM substance WHERE name='Urate [Uric acid]'), 'urate', 'BiGG'),
	((SELECT id FROM substance WHERE name='Urea'), 'urea', 'BiGG'),
	((SELECT id FROM substance WHERE name='Urea [CH4N2O]'), 'urea', 'BiGG'),
	((SELECT id FROM substance WHERE name='Urea; Carbamide'), 'urea', 'BiGG'),
	...
	-- Substance names starting with 'V'
	((SELECT id FROM substance WHERE name='Vaccenic acid'), 'vacc', 'BiGG'),
	((SELECT id FROM substance WHERE name='Valeric acid [Isovaleric acid]'), 'M03134', 'BiGG'),
	((SELECT id FROM substance WHERE name='Valine'), 'val__L', 'BiGG'),
	((SELECT id FROM substance WHERE name='Vitamin B12'), 'cbl1', 'BiGG'),
	((SELECT id FROM substance WHERE name='Vitamin B12'), 'b12', 'BiGG'),
	((SELECT id FROM substance WHERE name='Vitamin B12'), 'cbl2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Vitamin B12 [Cyanocobalamine]'), 'b12', 'BiGG'),
	((SELECT id FROM substance WHERE name='Vitamin D2; Ergocalciferol'), 'vitd2', 'BiGG'),
	-- Substance names starting with 'W'
	((SELECT id FROM substance WHERE name='Water'), 'h2o', 'BiGG'),
	-- Substance names starting with 'X'
	...
	-- Substance names starting with 'Z'
	((SELECT id FROM substance WHERE name='Zinc'), 'zn2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Zinc [ZnCl2]'), 'zn2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Zinc [ZnSO4 * 7H2O]'), 'zn2', 'BiGG'),
	((SELECT id FROM substance WHERE name='Zinc; Zn2+'), 'zn2', 'BiGG'),
	-- Substance names starting with 'beta'
...
--
INSERT INTO medium2substance(medium_id, substance_id, flux, origin) VALUES
-- LB medium
	-- LB: Carbohydrates
	...
	-- LB: Vitamins
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Thiamin'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Riboflavin'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='R-Pantothenate'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Pyridoxine'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Biotin'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Folate'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Vitamin B12'), NULL, NULL),
	-- LB: Other chemicals
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Sodium; Na+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Chloride; Cl-'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Sulfate'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Potassium; K+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Calcium; Ca2+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Magnesium'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Selenium'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Zinc; Zn2+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Arsenite; should be Arsenic'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Cadmium'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Mercury; Hg2+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Lead'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='O2'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='H+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='H2O'), NULL, NULL),
	-- LB: From CarveMe definition
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='AMP'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Co2+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Cu2+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Fe2+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Fe3+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='GMP'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Lipoate'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Mn2+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Molybdate'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Nicotinic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Ammonium'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Ni2+'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='Protoheme'), NULL, NULL),
	((SELECT id from medium WHERE name='LB'), (SELECT id from substance WHERE name='UMP'), NULL, NULL),
-- M9
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='Ca2+'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='Cl-'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='D-Glucose'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='H2O'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='H+'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='K+'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='Mg'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='Na+'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='Ammonium'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='O2'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='Phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='M9'), (SELECT id from substance WHERE name='Sulfate'), NULL, NULL),
-- SNM3
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Alanine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Arginine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Cysteine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Glutamate [Glutamic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Glycine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Histidine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Leucine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Lysine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Ornithine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Phenylalanine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Proline'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Serine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Threonine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Tryptophane'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Valine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Citrate [Citric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Fumarate [Fumaric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Malate [Maleic acid]'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Glucose'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Urea'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Sodium'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Chloride'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Potassium'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Magnesium'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Sulphate'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='2,2-Bipyridine'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Calcium'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Zinc [ZnCl2]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Manganese [MnCl2]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='H3BO3'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Co2+ [CoCl2]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Copper [CuCl2]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Nickel [NiCl2]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Molybdate [MoNa2O4]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Cob(I)alamin [Cyanocobalamine]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Cob(II)alamin [Cyanocobalamine]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Vitamin B12 [Cyanocobalamine]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='4-Aminobenzoate [p-Aminobenzoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Biotin'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Nicotinate [Nicotinic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='(R)-Pantothenate [Ca-D-Pantothenic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Pyridoxamine [Pyridoxamine-2HCl]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Thiamin [Thiamine-dichloride]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Riboflavin'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='O2 [Oxygen]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Iron (Fe2+)'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='Iron (Fe3+)'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='H2O [Water]'), NULL, NULL),
	((SELECT id from medium WHERE name='SNM3'), (SELECT id from substance WHERE name='CO2'), NULL, NULL),
-- RPMI
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Calcium'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Nitrate'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Magnesium'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Sulfate'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Chloride'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Potassium'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Sodium'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Glycine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Arginine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='L-Asparagine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Aspartic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='L-Cysteine'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Histidine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Isoleucine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Leucine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Methionine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Phenylalanine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Proline'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Serine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Threonine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='L-Tryptophan'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='L-Tyrosine disodium salt dihydrate'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='4-Aminobenzoate'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Riboflavin'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Thiamin'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Myo-Inositol; should be I-Inositol'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Pantothenic acid; (R)-Pantothenate'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Folate'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Pyridoxine'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Vitamin B12'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Glucose'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Reduced glutathione'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Water'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Oxygen'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Bicarbonate'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Trans-4-Hydroxy-L-proline'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Carbondioxide'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='H+; Hydrogen'), NULL, NULL),
	((SELECT id from medium WHERE name='RPMI'), (SELECT id from substance WHERE name='Phenol Red'), NULL, NULL),
-- Casamino acids
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Lysine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Histidine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Arginine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Aspartic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Threonine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Glutamic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Glycine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Valine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Methionine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Isoleucine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Leucine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Tyrosine'), NULL, NULL),
	((SELECT id from medium WHERE name='CasA'), (SELECT id from substance WHERE name='Phenylalanine'), NULL, NULL),
-- CGXII
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Ammonium'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Sulfate'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Potassium'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Urea; Carbamide'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Calcium'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Chloride'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Magnesium'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Iron'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Manganese'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Nickel'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Copper'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Zinc'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Biotin'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Glucose'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Water'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Oxygen'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='Sodium'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='H+; Hydrogen'), NULL, NULL),
	((SELECT id from medium WHERE name='CGXII'), (SELECT id from substance WHERE name='3,4-Dihydroxybenzoate; Protocatechuic acid'), NULL, NULL),
-- Blood
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='2-Oxoglutarate [Oxoglutaric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Acetoacetate [Acetoacetic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Adenosine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Butyrate [Butyric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Citrate [Citric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Fumarate [Fumeric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Glucosamine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Glucuronate [D-Glucuronic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Lactate [D-Lactic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Lactate [L-Lactic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Malate [L-Malic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Malate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Myo-Inositol'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Nicotinate [Nicotinic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Pyruvate [Pyruvic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Succinate [Succinic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Thiamin [Thiamine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='2 Hydroxybutyrate [2-Hydroxybutyric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='(R)-3-Hydroxybutanoate [(R)-3-Hydroxybutyric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Deoxyuridine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Deoxycytidine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='4-Pyridoxate [4-Pyridoxic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='3-Methyl-2-oxobutanoate [alpha-Ketoisovaleric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='4-Hydroxyphenylacetate [p-Hydroxyphenylacetic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Biotin'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Andrstrn [Androsterone]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Carnosine [Carnosine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Adenine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Taurocholic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Acetate [Acetic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Glycine betaine [Betaine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Ascorbate [Ascorbic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='AMP [Adenosine monophosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Ammonia'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Billirubin'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='beta-Alanine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='CAMP [Cyclic AMP]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Carnitine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Crtsl [Cortisol]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Creatine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Chsterol [Cholesterol]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Cys Gly [Cysteinylglycine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Cytidine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Choline'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Xylose'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Ethanol'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='4-Aminobutanoate [gamma-Aminobutyric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Folate [Folic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Glycine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Reduced glutathione [Glutathione]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Glycerol 3-phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Glycerol'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Guanosine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Glycocholate [Glycocholic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Formate [Formic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Galactose'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Glutamate [L-Glutamic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Hypoxanthine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Tyrosine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Phenylalanine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Alanine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Proline'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Threonine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Asparagine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Mannose'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Isoleucine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='IMP [Inosinic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Histidine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='3,4-Dihydroxy-L-phenylalanine [L-Dopa]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Lysine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Serine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Aspartate [L-Aspartic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L Cystine [L-Cystine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Cystathionine [L-Cystine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Inosine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Octadecenoate [Oleic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='(R)-Pantothenate [Pantothenic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Ornithine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Norepinephrine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Nicotinamide adenine dinucleotide phosphate [NADP]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Hexadecanoate [Palmitic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Orotate [Orotic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Tststerone [Testosterone]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Propionate [Propionic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Pyridoxine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sulfite'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Riboflavin'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Sorbitol [Sorbitol]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Sorbitol [Sorbitol]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Thyroxine [Thyroxine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Diphosphate [Pyrophosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Taurine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Thiosulfate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sucrose'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Serotonin'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='5-Oxoproline [Pyroglutamic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sarcosine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Thymidine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sphingosine 1-phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='5-Phospho-alpha-D-ribose 1-diphosphate [Phosphoribosyl pyrophosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Ribose'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='UDPglucose [Uridine diphosphate glucose]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='UMP [Uridine 5-monophosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Urate [Uric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Urea'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='UDP [Uridine 5-diphosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Uridine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Uracil'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='All-trans-Retinol [Vitamin A]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='9-cis-retinol [Vitamin A]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='3,4-Dihydroxyphenylethyleneglycol [3,4-Dihydroxyphenylglycol]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='2-Methylcitrate [2-Methylcitric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Calcium'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='5-Hydroxy-L-tryptophan'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Octanoate [Caprylic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='(S)-3-Methyl-2-oxopentanoate [3-Methyl-2-Oxovaleric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Chloride [Chloride ion]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Ribitol'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Decanoate [Capric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Arginine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Chenodeoxycholate [Chenodeoxycholic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='ATP [Adenosine triphosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Beta-Carotene [B-Carotene]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Elaidic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Cysteine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Potassium'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sodium'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Bicarbonate [Hydrogen carbonate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Cholate [Cholic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Deoxycholate [Deoxycholic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Cytosine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Chenodeoxyglycocholate [Chenodeoxycholic acid glycine conjugate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Dodecanoate [Dodecanoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Glutamine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Arabinose'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Decanoyl Carnitine [Decanoylcarnithine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Fructose'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Linoleic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Leucine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Isovaleryl Carnitine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Fe2+'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Iron (Fe3+)'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='4-Methyl-2-oxopentanoate [Ketoleucine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Methionine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Glycolithocolate [Lithocholic acid glycine conjugate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='1 Methylnicotinamide [1-Methylnicothinamide]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='3-(4-Hydroxyphenyl)pyruvate [4-Hydroxyphenylpyruvic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Glycoursodeoxycholate [Glycoursodeoxycholic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Homoserine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Taurolithocholate [Lithocholyltaurine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Lithocholate [Lithocholic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Octanoyl carnitine [L-Octanoylcarnitine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Phytanic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Tetradecanoate [Myristic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Pentadecanoate [Pentadecanoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Octadecanoate [Stearic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Calciol; (+)-Vitamin D3 [Vitamin D3]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Xanthurenic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Valine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Taurodeoxycholate [Taurodeoxycholic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Vitamin D2; Ergocalciferol'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Nicotinamide adenine dinucleotide [NAD]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Citrulline [Citrulline]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-Tryptophan'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Behenate, Docosanoate [Behenic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Ursodeoxycholate [Ursodeoxycholic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Taurochenodeoxycholate [Taurochenodesoxycholic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Acetaldehyde'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Dehydroepiandrosterone sulfate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Arachidonic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='7,8-Dihydrofolate [Dihydrofolic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Anthranilate [2-Aminobenzoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Methylglyoxal [Pyruvaldehyde]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='GDP [Guanosine diphosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Flavin adenine dinucleotide oxidized [FAD]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Spermine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Spermidine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Dehydroascorbate [Dehydroascorbic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='GTP [Guanosine triphosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Alanine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='2,3-Cyclic GMP [Cyclic GMP]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='3,5-Cyclic GMP [Cyclic GMP]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='ADP'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='All-trans-Retinal [Retinal]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Carbon monoxide'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='O2 [Oxygen]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sphinganine 1 phosphate [Sphinganine 1-phosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Alpha-Linolenic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Alpha linolenic acid [Alpha-Linolenic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='5-Methyltetrahydrofolate [5-Methyltetrahydrofolic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='GMP [Guanosine monophosphate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Niacinamide'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Putrescine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Estrone sulfate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Formaldehyde'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Pyridoxamine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='25-Hydroxyvitamin D2'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sulfate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Lipoate [(R)-lipoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Thiocyanate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Dihydroxyacetone phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Pyridoxal 5-phosphate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='FMN [Flavin Mononucleotide]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Pyridoxal'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='CDP'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Corticosterone'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='5-Formyltetrahydrofolate [Folinic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Acetone'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Prgstrn [Progesterone]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='5,6,7,8-Tetrahydrofolate [Tetrahydrofolic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L Arabinitol [L-Arabitol]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Retinoate [All-trans-retinoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Benzoate [Benzoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Methanol'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Alpha-Tocopherol'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='CO2 [Carbon dioxide]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Timnodonic acid [Eicosapentaenoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Lignoceric acid or tetracosanoicacid [Tetracosanoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Lignoceric acid [Tetracosanoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Ubiquinone-10'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Butyryl carnitine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Hyaluronan [Hyaluronic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sulfate derivative of norepinephrine [Norepinephrine sulfate]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='13Z)-13-docosenoic acid [Erucic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Cyanate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='H2O [Water]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='L-3-Amino-isobutanoate [(S)-b-aminoisobutyric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Eicosatetranoic acid [Cis-8,11,14,17-Eicosatetranoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Cervonic acid [Docosahexaenoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Arachidic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Adrenic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Heptadecanoate [Heptadecanoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Oxalate [Oxalic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Hexacosanoate [Hexacosanoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Nervonic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sulfoglycolithocholate [Sulfolithocholylglycine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Nitrite'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='3-Methylimidazoleacetic acid [Methylimidazoleacetic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Androsterone glucuronide'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Xylitol [D-Xylitol]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Dihomo-gamma-linolenic acid [8,11,14-Eicosatrienoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='5alpha-Dihydrotestosterone [Dihydrotestosterone]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='20alpha-Dihydroprogesterone [20a-Dihydroprogesterone]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Gamma-Linolenic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Hydrogen peroxide'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Retinoyl glucuronide [Retinoyl b-glucuronide]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Hexadecenoate [Palmitoleic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Vaccenic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Thromboxane-b2 [Thromboxane B2]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Hydrosulfide [Hydrogen sulfide]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Hydrogen sulfide'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Oxidized glutathione'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Limnen (D-Limonene)'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='D-Serine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='25-Hydroxyvitamin D3 [Calcidiol]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Phylloquinone (old identifier for [Vitamin K1])'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Phylloquinone [Vitamin K1]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Metanephrine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Globoside (homo sapiens) [Tetrahexosylceramide (d18:1/12:0)]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Dopamine 3-O-Sulfate'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Alpha-Tocotrienol'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Beta-Tocopherol'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Alpha-N-Phenylacetyl-L-glutamine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='(S)-Glycerate [L-Glyceric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='4hdebrisoquine [4-Hydroxydebrisoquine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Debrisoquine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Stearidonic acid'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Octenoyl Carnithine [2-Octenoylcarnithine]'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='3-Hydroxyhexadecanoylcarnithine'), NULL, NULL),
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='H+ [Protons]'), NULL, NULL),
-- MP-AU
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Sodium [NaCl]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Chloride [NaCl]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Sulfate [Na2SO4]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Urate [Uric acid (C5H4N4O3)]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Citrate [Sodium citrate (Na3C6H5O7.2H2O)]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Creatinine [C4H7N3O]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Urea [CH4N2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Potassium [KCl]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Calcium [CaCl2]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Ammonium [NH4Cl]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Oxalate [Potassium Oxalate (K2C2O4.H2O)]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Magnesium [MgSO4.7H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Hydrogen [NaH2PO4.2H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='Phosphate [NaH2PO4.2H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='H+ [Na2HPO4.2H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='H2O'), NULL, NULL),
	((SELECT id from medium WHERE name='MP-AU'), (SELECT id from substance WHERE name='O2 [Oxygen]'), NULL, NULL),
--dGMM
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='D-Glucose'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Fructose'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Resazurin'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Heme D [Hematin]'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Fe2+ [FeSO4 . 7H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Sulfate [FeSO4 . 7H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='H2O [FeSO4 . 7H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Zinc [ZnSO4 * 7H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Co2+ [Co(NO3)2 . 6H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Nitrate [Co(NO3)2 . 6H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Potassium [AlK(SO4)2 (anhydrous)]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Sodium [NaCl]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Chloride [NaCl]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Selenite [Na2SeO3 (anhydrous)]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Tungstate [Na2WO4 . 2H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Nickel [NiCl2 . 6H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Calcium [CaCl2 (anhydrous)]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Copper [CuSO4 (anhydrous)]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='H3BO3'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Manganese [MnSO4 * H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Magnesium [MgSO4 * 7H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Bicarbonate [NaHCO3]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Molybdate [Na2MoO4 . 2H2O]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Biotin'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Thiamin [Thiamine HCl]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Riboflavin'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Nicotinate [Niacin]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Pyridoxine [Pyridoxine HCl]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='(R)-Pantothenate [Calcium Pantothenate]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Folate [Folic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='4-Aminobenzoate [p-Aminobenzoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Lipoate [Lipoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Lipoate (protein bound) [Lipoic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Vitamin B12'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Cob(I)alamin [Vitamin B12]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Cob(II)alamin [Vitamin B12]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Menadione [Vitamin K (menadione)]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Acetate [Acetic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Valeric acid [Isovaleric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Isovalerate [Isovaleric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Propionate [Propionic acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Butyrate [Butyric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Isobutyric acid [Butyric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Isobutyrate [Butyric acid]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Hydrogen [KH2PO4]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='Phosphate [KH2PO4]'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='EDTA'), NULL, NULL),
	((SELECT id from medium WHERE name='dGMM'), (SELECT id from substance WHERE name='CO2 [Carbon dioxide]'), NULL, NULL),
