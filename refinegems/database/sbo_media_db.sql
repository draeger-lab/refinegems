...
-- Blood
	...
	((SELECT id FROM medium WHERE name='Blood'), (SELECT id FROM substance WHERE name='3-[(4-Amino-2-methylpyrimidin-5-yl)methyl]-5-(2-hydroxyethyl)-4-methyl-1,3-thiazol-3-ium chloride [Thiamine dichloride]'), 8.86666666666667e-05, 'Thiamine'),
	((SELECT id FROM medium WHERE name='Blood'), (SELECT id FROM substance WHERE name='4,5-Bis(hydroxymethyl)-2-methylpyridin-3-ol [Pyridoxinde]'), 2.5e-05, 'Pyridoxine'),
	...
	((SELECT id FROM medium WHERE name='Blood'), (SELECT id FROM substance WHERE name='L Cystine [L-Cystine]'), 0.10118, 'L-Cystine'),
	...
	((SELECT id FROM medium WHERE name='Blood'), (SELECT id FROM substance WHERE name='Ornithine'), 61.0, 'Ornithine'),
