...
-- Blood
	...
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Cholesterol'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='Sphinganine 1-phosphate'), NULL, NULL),
	...
	((SELECT id from medium WHERE name='Blood'), (SELECT id from substance WHERE name='(4R)-1-Methyl-4-(prop-1-en-2-yl)cyclohex-1-ene [D-Limonene]'), NULL, NULL),
